...
`room-inspiration.webp` is AI-generated design imagery, visibly labelled “Design illustration”; it is not presented as a completed Winco installation. The original generated PNG remains in the Codex generated-images folder. No fabricated testimonials, review scores, installation counts or fixed lead times were added. The owner confirmed a 5-year warranty on 2026-09-24; FAQ, services and care pages state this period without inventing coverage or exclusions.

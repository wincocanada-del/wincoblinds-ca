...
<div class="pill" data-mode-target="newQuote">New Quote</div>
<button class="btn" data-mode-target="quoteView" type="button">Edit</button>
<button class="btn" data-mode-target="common" type="button">Save</button>
</div>
</div>
<div class="page">
<div class="meta">
<div>
<div style="font-size:16px;font-weight:600"># Q260318-01</div>
</div>
<div class="meta-right">
<span>03/18/2026 14:30</span>
<div class="dropdown" id="unitDropdown">
<span id="unitLabel">ft+inch</span><span>▾</span>
</div>
<div class="client-menu hidden" id="unitMenu" style="right:0; top:46px; margin-top:0;">
<div class="client-option" data-unit-option="ft+inch">ft+inch</div>
<div class="client-option" data-unit-option="inch">inch</div>
<div class="client-option" data-unit-option="mm">mm</div>
</div>
</div>
</div>
<div class="card" id="informationCard">
<div class="card-header info-card-toggle" onclick="toggleInformationCard()">
<div class="card-title"><div class="dot"></div><span style="font-size:16px;font-weight:600">Information</span></div>
<div class="info-toggle-icon" id="infoToggleIcon">▴</div>
</div>
<div class="grid12 info-card-body-hidden" style="display:grid;">
<div class="col-8">
<div class="grid12" style="align-items:start;">
<div class="col-4"><div class="field-label">Tag</div><div class="field"></div></div>
<div class="col-4" style="position:relative;">
<div class="field-label">Client</div>
<div class="field" onclick="toggleClientMenu(this)">
<span class="placeholder">Select...</span>
</div>
<div class="client-menu hidden">
<div class="client-option">New client</div>
<div class="client-option">Select client</div>
</div>
<div class="client-search hidden">
<div class="field placeholder">Search client</div>
</div>
</div>
<div class="col-2" style="position:relative;">
<div class="field-label">Account</div>
<div class="field" onclick="toggleDealerMenu(this)">
<span class="placeholder">Account</span>
</div>
<div class="client-menu hidden">
<div class="client-option" onclick="selectDealer(this,'Winco')">Winco</div>
<div class="client-option" onclick="selectDealer(this,'Dealer A')">Dealer A</div>
<div class="client-option" onclick="selectDealer(this,'Dealer B')">Dealer B</div>
<div class="client-option" onclick="selectDealer(this,'Dealer C')">Dealer C</div>
<div class="client-option" onclick="selectDealer(this,'None')">None</div>
</div>
</div>
<div class="col-2" style="position:relative;">
<div class="field-label">Type</div>
<div class="field" onclick="toggleTypeMenu(this)">
<span class="placeholder">Type</span>
</div>
<div class="client-menu hidden">
<div class="client-option" onclick="selectType(this,'House')">House</div>
<div class="client-option" onclick="selectType(this,'Condo')">Condo</div>
<div class="client-option" onclick="selectType(this,'Commercial')">Commercial</div>
<div class="client-option" onclick="selectType(this,'Other')">Other</div>
</div>
</div>
<div class="col-12 row-split">
<div class="col-5"><div class="field placeholder">Name</div></div>
<div class="col-7"><div class="field placeholder">Address</div></div>
</div>
<div class="col-12 row-split">
<div class="col-5"><div class="field placeholder">Phone</div></div>
<div class="col-7"><div class="field placeholder">E-mail</div></div>
</div>
</div>
</div>
<div class="col-4">
<div class="grid12" style="align-items:stretch; height:100%;">
<div class="col-12" style="display:flex; flex-direction:column;">
<div class="field-label">General Comments</div>
<div class="comments-box" style="flex:1;"></div>
</div>
</div>
</div>
</div>
...
<div class="window-title"><span data-window-label="1">Window #1</span><span data-window-meta="1"></span></div>
<button class="check checked" onclick="toggleCheck(this)" type="button"><span class="check-box">✓</span><span>Include</span></button>
</div>
<div class="grid12">
<div class="col-1" style="position:relative;">
<div class="field-label">Location</div>
<div class="field" onclick="toggleLocationMenu(this)">
<span class="placeholder">Floor</span>
</div>
<div class="client-menu hidden">
<div class="client-option" onclick="selectLocation(this,'B1')">B1</div>
<div class="client-option" onclick="selectLocation(this,'1F')">1F</div>
<div class="client-option" onclick="selectLocation(this,'2F')">2F</div>
<div class="client-option" onclick="selectLocation(this,'3F')">3F</div>
<div class="client-option" onclick="selectLocation(this,'custom')">Custom</div>
</div>
</div>
<div class="col-3" style="position:relative;">
<div class="field-label">\xA0</div>
<div class="room-type-combo" onclick="toggleRoomMenu(this)">
<div class="room-type-value">
<span class="placeholder" data-room-display="">Select Room</span>
</div>
</div>
<div class="client-menu hidden">
<div class="client-option" onclick="selectRoom(this,'custom')">Custom</div>
<div class="client-option" onclick="selectRoom(this,'Foyer')">Foyer</div>
<div class="client-option" onclick="selectRoom(this,'Living')">Living</div>
<div class="client-option" onclick="selectRoom(this,'Dining')">Dining</div>
<div class="client-option" onclick="selectRoom(this,'Kitchen')">Kitchen</div>
<div class="client-option" onclick="selectRoom(this,'Master')">Master</div>
<div class="client-option" onclick="selectRoom(this,'Room')">Room</div>
<div class="client-option" onclick="selectRoom(this,'Washroom')">Washroom</div>
<div class="client-option" onclick="selectRoom(this,'Bonus room')">Bonus room</div>
<div class="client-option" onclick="selectRoom(this,'Den')">Den</div>
<div class="client-option" onclick="selectRoom(this,'Flex room')">Flex room</div>
<div class="client-option" onclick="selectRoom(this,'Office')">Office</div>
<div class="client-option" onclick="selectRoom(this,'Pantry')">Pantry</div>
<div class="client-option" onclick="selectRoom(this,'Deck Door')">Deck Door</div>
<div class="client-option" onclick="selectRoom(this,'Door window')">Door window</div>
<div class="client-option" onclick="selectRoom(this,'Stair')">Stair</div>
<div class="client-option" onclick="selectRoom(this,'Laundry')">Laundry</div>
</div>
</div>
<div class="col-3"><div class="field-label">\xA0</div><div class="field"><input data-sidemark-input="1" oninput="updateWindowTitleMeta(1)" placeholder="Sidemark" type="text"/></div></div>
<div class="col-2"><div class="field-label">W (mm)</div><div class="dimension-field" data-dimension="w" data-mm-value=""></div></div>
<div class="col-2"><div class="field-label">H (mm)</div><div class="dimension-field" data-dimension="h" data-mm-value=""></div></div>
<div class="col-1" style="position:relative;">
<div class="field-label">Mount</div>
<div class="mount-type-combo" data-mount-type-wrapper="" onclick="toggleMountTypeMenu(this)">
<div class="mount-type-value" data-mount-type-value="">
<span class="placeholder" data-mount-type-display="">Select</span>
</div>
</div>
<div class="client-menu menu-right-align hidden">
<div class="client-option" onclick="selectMountType(this,'IN')">IN\xA0\xA0\xA0Inside Mount</div>
<div class="client-option" onclick="selectMountType(this,'FF')">FF\xA0\xA0\xA0Frame Mount</div>
<div class="client-option" onclick="selectMountType(this,'FW')">FW\xA0\xA0\xA0Wall Mount</div>
<div class="client-option" onclick="selectMountType(this,'FD')">FD\xA0\xA0\xA0Door Mount</div>
<div class="client-option" onclick="selectMountType(this,'custom')">Custom</div>
</div>
</div>
<div class="col-12 split-row hidden">
<div class="split-row-inner" data-split-container="">
<div class="split-fields" data-split-fields="">
<div class="split-item">
<div class="split-label">2/1 (Left)</div>
<div class="split-combo">
<div class="split-seg"><input class="split-mm-input" placeholder="mm" type="number"/></div>
<div class="split-seg">
<div class="split-select-display" onclick="toggleSplitCtrlMenu(this, event)">None</div>
<div class="client-menu split-select-menu hidden">
<div class="client-option" onclick="selectSplitCtrl(this,'None', event)">None</div>
<div class="client-option" onclick="selectSplitCtrl(this,'L', event)">L</div>
<div class="client-option" onclick="selectSplitCtrl(this,'R', event)">R</div>
</div>
</div>
</div>
</div>
<div class="split-item">
<div class="split-label">2/2 (Right)</div>
<div class="split-combo">
<div class="split-seg"><input class="split-mm-input" placeholder="mm" type="number"/></div>
<div class="split-seg">
<div class="split-select-display" onclick="toggleSplitCtrlMenu(this, event)">None</div>
...
<div class="field-label">\xA0</div>
<div class="field" style="justify-content:center; gap:20px; padding:0 10px; width:100%;">
<span onclick="changeSplit(this,-1)" style="cursor:pointer; user-select:none; font-size:18px; line-height:1;">−</span>
<span onclick="changeSplit(this,1)" style="cursor:pointer; user-select:none; font-size:18px; line-height:1;">+</span>
</div>
</div>
</div>
...
<div class="field" onclick="toggleGroupMenu(this)">
<span class="placeholder">Shade</span>
</div>
<div class="client-menu hidden">
<div class="client-option" onclick="selectGroup(this,'Dual')">Dual Shade</div>
<div class="client-option" onclick="selectGroup(this,'Roller')">Roller Shade</div>
</div>
</div>
<div class="col-4">
<div class="field-label">Product</div>
<div class="product-combo" style="grid-template-columns:3fr 1fr;">
<div class="product-seg placeholder">Fabric</div>
<div class="product-seg placeholder">Color</div>
</div>
</div>
<div class="col-3" style="position:relative;">
<div class="field-label">Model / System</div>
<div class="rail-combo">
<div class="rail-seg placeholder">Head rail</div>
<div class="rail-seg clickable placeholder" onclick="toggleRailColorMenu(this, event)">Color</div>
</div>
<div class="client-menu hidden menu-right-align">
<div class="client-option" onclick="selectRailColor(this,'01')">01\xA0\xA0\xA0White</div>
<div class="client-option" onclick="selectRailColor(this,'02')">02\xA0\xA0\xA0Ivory</div>
<div class="client-option" onclick="selectRailColor(this,'03')">03\xA0\xA0\xA0Grey</div>
<div class="client-option" onclick="selectRailColor(this,'04')">04\xA0\xA0\xA0Anodized</div>
<div class="client-option" onclick="selectRailColor(this,'05')">05\xA0\xA0\xA0Black</div>
</div>
</div>
<div class="col-3" style="position:relative;">
<div class="field-label">\xA0</div>
<div class="rail-combo">
<div class="rail-seg placeholder">Bottom rail</div>
<div class="rail-seg clickable placeholder" onclick="toggleRailColorMenu(this, event)">Color</div>
</div>
<div class="client-menu hidden menu-right-align">
<div class="client-option" onclick="selectRailColor(this,'01')">01\xA0\xA0\xA0White</div>
...
<div class="col-1" style="position:relative;">
<div class="field-label">Config</div>
<div class="field" onclick="toggleConfigMenu(this)">
<span>Single</span>
</div>
<div class="client-menu hidden menu-right-align">
<div class="client-option" onclick="selectConfig(this,'Single')">Single</div>
<div class="client-option" onclick="selectConfig(this,'Multi')">Multi</div>
<div class="client-option" onclick="selectConfig(this,'Linked')">Linked</div>
</div>
</div>
<div class="col-3"><div class="field-label">Control Type</div><div class="field">Chain / Manual</div></div>
<div class="col-1" style="position:relative;">
<div class="field-label">Ctrl Side</div>
<div class="field" onclick="toggleCtrlSideMenu(this)">
<span class="placeholder">L/R</span>
</div>
<div class="client-menu hidden">
<div class="client-option" onclick="selectCtrlSide(this,'L')">L</div>
<div class="client-option" onclick="selectCtrlSide(this,'R')">R</div>
</div>
</div>
<div class="col-1">
<div class="field-label">Length</div>
<div class="length-field">
<div class="length-prefix" data-length-prefix="">N</div>
<input class="length-input" type="text" value=""/>
</div>
</div>
<div class="col-7">
<div class="field-label">Chain Control Option</div>
<div class="option-box">
<button class="check" data-chain-weight-toggle="" onclick="toggleCheck(this)" type="button"><span class="check-box">✓</span><span>No Chain Weight</span></button>
<button class="check" onclick="toggleCheck(this)" type="button"><span class="check-box">✓</span><span>Chain Clip</span></button>
<button class="check" onclick="toggleCheck(this)" type="button"><span class="check-box">✓</span><span>Chain Guard</span></button>
</div>
</div>
<div class="col-6"><div class="field-label">Option</div><div class="option-box"><button class="check" onclick="toggleCheck(this)" type="button"><span class="check-box">✓</span><span>Spring Assist</span></button></div></div>
<div class="col-6"><div class="field-label">Memo</div><div class="option-box"></div></div>
</div>
<div class="window-footer">
<div class="buttons">
<button class="btn" onclick="duplicateWindowCard(this)" type="button">Duplicate</button>
<button class="btn btn-danger" onclick="deleteWindowCard(this)" type="button">Delete</button>
</div>
...
<div class="win-summary-bottom">
<span data-window-sqft="1">Sqft 0</span>
<span class="win-summary-total">Total $580</span>
</div>
</div>
</div>
</div>
<div class="card">
<div class="window-head">
<div class="window-title"><span data-window-label="2">Window #2</span><span data-window-meta="2"></span></div>
<button class="check checked" onclick="toggleCheck(this)" type="button"><span class="check-box">✓</span><span>Include</span></button>
</div>
<div class="grid12">
<div class="col-1" style="position:relative;">
...
<div class="col-3"><div class="field-label">\xA0</div><div class="field"><span class="placeholder">Select Room</span></div></div>
<div class="col-3"><div class="field-label">\xA0</div><div class="field"><input data-sidemark-input="2" oninput="updateWindowTitleMeta(2)" placeholder="Sidemark" type="text"/></div></div>
<div class="col-2"><div class="field-label">W (mm)</div><div class="dimension-field" data-dimension="w" data-mm-value=""></div></div>
<div class="col-2"><div class="field-label">H (mm)</div><div class="dimension-field" data-dimension="h" data-mm-value=""></div></div>
<div class="col-1" style="position:relative;">
<div class="field-label">Mount</div>
...
<div class="col-3"><div class="field-label">Control Type</div><div class="field">Motorized</div></div>
<div class="col-4"><div class="field-label">Motor</div><div class="field" style="justify-content:space-between; cursor:default;"><span class="placeholder">Select Motor</span><span class="placeholder">▾</span></div></div>
<div class="col-1" style="position:relative;">
<div class="field-label">Ctrl Side</div>
<div class="field" onclick="toggleCtrlSideMenu(this)">
<span class="placeholder">L/R</span>
...
<div class="col-6"><div class="field-label">Option</div><div class="option-box"><button class="check" onclick="toggleCheck(this)" type="button"><span class="check-box">✓</span><span>Bottom bar brush</span></button><button class="check" onclick="toggleCheck(this)" type="button"><span class="check-box">✓</span><span>Side channel</span></button></div></div>
<div class="col-6"><div class="field-label">Memo</div><div class="option-box"></div></div>
</div>
<div class="window-footer">
<div class="buttons">
...
<div class="win-summary-bottom">
<span data-window-sqft="2">Sqft 0</span>
<span class="win-summary-total">Total $580</span>
</div>
</div>
</div>
...
<div class="card">
<div class="window-head">
<div class="window-title"><span data-window-label="3">Window #3</span><span data-window-meta="3"></span></div>
<button class="check checked" onclick="toggleCheck(this)" type="button"><span class="check-box">✓</span><span>Include</span></button>
</div>
<div class="grid12">
<div class="col-1" style="position:relative;">
...
<div class="col-3"><div class="field-label">\xA0</div><div class="field"><span class="placeholder">Select Room</span></div></div>
<div class="col-3"><div class="field-label">\xA0</div><div class="field"><input data-sidemark-input="3" oninput="updateWindowTitleMeta(3)" placeholder="Sidemark" type="text"/></div></div>
<div class="col-2"><div class="field-label">W (mm)</div><div class="dimension-field" data-dimension="w" data-mm-value=""></div></div>
<div class="col-2"><div class="field-label">H (mm)</div><div class="dimension-field" data-dimension="h" data-mm-value=""></div></div>
<div class="col-1" style="position:relative;">
<div class="field-label">Mount</div>
...
<div class="col-3"><div class="field-label">Control Type</div><div class="field">Cordless</div></div>
<div class="col-3"><div class="field-label">Cordless Type</div><div class="field" style="justify-content:space-between; cursor:default;"><span class="placeholder">Select Type</span><span class="placeholder">▾</span></div></div>
<div class="col-6"><div class="field-label">Cordless Option</div><div class="option-box"><button class="check" onclick="toggleCheck(this)" type="button"><span class="check-box">✓</span><span>Pull tap</span></button><button class="check" onclick="toggleCheck(this)" type="button"><span class="check-box">✓</span><span>Hold down bracket</span></button><button class="check" onclick="toggleCheck(this)" type="button"><span class="check-box">✓</span><span>Reach cord</span></button><span class="inline-value hidden">12"</span></div></div>
<div class="col-6"><div class="field-label">Option</div><div class="option-box"><button class="check" onclick="toggleCheck(this)" type="button"><span class="check-box">✓</span><span>Bottom bar brush</span></button><button class="check" onclick="toggleCheck(this)" type="button"><span class="check-box">✓</span><span>Side channel</span></button></div></div>
<div class="col-6"><div class="field-label">Memo</div><div class="option-box"></div></div>
</div>
<div class="window-footer">
...
<div class="win-summary-bottom">
<span data-window-sqft="3">Sqft 0</span>
<span class="win-summary-total">Total $580</span>
</div>
</div>
</div>
...
<div class="card">
<div class="window-head">
<div class="window-title"><span data-window-label="4">Window #4</span><span data-window-meta="4"></span></div>
<button class="check checked" onclick="toggleCheck(this)" type="button"><span class="check-box">✓</span><span>Include</span></button>
</div>
<div class="grid12">
<div class="col-1" style="position:relative;">
...
<div class="col-3"><div class="field-label">\xA0</div><div class="field"><span class="placeholder">Select Room</span></div></div>
<div class="col-3"><div class="field-label">\xA0</div><div class="field"><input data-sidemark-input="4" oninput="updateWindowTitleMeta(4)" placeholder="Sidemark" type="text"/></div></div>
<div class="col-2"><div class="field-label">W (mm)</div><div class="dimension-field" data-dimension="w" data-mm-value=""></div></div>
<div class="col-2"><div class="field-label">H (mm)</div><div class="dimension-field" data-dimension="h" data-mm-value=""></div></div>
<div class="col-1" style="position:relative;">
<div class="field-label">Mount</div>
...
<div class="col-3"><div class="field-label">Control Type</div><div class="field">Select control type</div></div>
<div class="col-1" style="position:relative;">
<div class="field-label">Ctrl Side</div>
<div class="field" onclick="toggleCtrlSideMenu(this)">
<span class="placeholder">L/R</span>
...
<div aria-hidden="true" class="col-8"></div>
<div class="col-6"><div class="field-label">Option</div><div class="option-box"></div></div>
<div class="col-6"><div class="field-label">Memo</div><div class="option-box"></div></div>
</div>
<div class="window-footer">
<div class="buttons">
...
<div class="win-summary-bottom">
<span data-window-sqft="4">Sqft 0</span>
<span class="win-summary-total">Total $580</span>
</div>
</div>
</div>
...
<div class="card-title"><span style="font-size:16px;font-weight:600">Review</span></div>
<div style="display:flex;gap:16px;color:var(--muted);font-size:13px;align-items:center">
<button class="check" onclick="toggleCheck(this)" type="button"><span class="check-box">✓</span><span>Show excluded items</span></button>
<span>Confirm excluded items before saving</span>
</div>
</div>
...
<thead>
<tr>
<th></th><th>No.</th><th>Loc</th><th>Fab</th><th>MT</th><th>HW</th><th>BT</th><th>Ctrl</th><th>L/R</th><th>Len</th><th>W</th><th>H</th><th>SF</th><th>$/SF</th><th>BLD</th><th>SUR</th><th>MOT</th><th>Total</th>
</tr>
</thead>
<tbody style="font-size:12px">
<tr><td><button class="check box-only" onclick="toggleCheck(this)" type="button"><span class="check-box">✓</span></button></td><td>1</td><td>1F Living - 1L</td><td>PUL 600</td><td>IN</td><td>SL01</td><td>OP01</td><td>CH</td><td>R</td><td>1000</td><td>1460</td><td>1460</td><td>23</td><td>$23.80</td><td>$547.40</td><td>$47.40</td><td>-</td><td style="font-weight:600;color:#0f172a">$594.40</td></tr>
<tr><td><button class="check box-only" onclick="toggleCheck(this)" type="button"><span class="check-box">✓</span></button></td><td>2</td><td>1F Living - 2R</td><td>PUL 600</td><td>IN</td><td>SL01</td><td>OP01</td><td>CH</td><td>R</td><td>1000</td><td>1460</td><td>1460</td><td>23</td><td>$23.80</td><td>$547.40</td><td>$47.40</td><td>-</td><td style="font-weight:600;color:#0f172a">$594.40</td></tr>
<tr><td><button class="check box-only" onclick="toggleCheck(this)" type="button"><span class="check-box">✓</span></button></td><td>3</td><td>1F Dining</td><td>PUL 600</td><td>IN</td><td>SL01</td><td>OP01</td><td>CH</td><td>R</td><td>1000</td><td>1460</td><td>1460</td><td>23</td><td>$23.80</td><td>$547.40</td><td>$50.40</td><td>$570.00</td><td style="font-weight:600;color:#0f172a">$1,167.80</td></tr>
</tbody>
</table>
</div>
<div class="tfoot-note">Total Sqft : 69</div>
<div class="review-bottom">
<div>
<div class="subgrid3">
<div><div class="field-label">Install</div><div class="field">0</div></div>
<div><div class="field-label">Extra Fee</div><div class="field">0</div></div>
<div></div>
</div>
<div class="subgrid3">
<div><div class="field-label">BLD / SUR Disc. %</div><div class="field">30</div></div>
<div><div class="field-label">OPT Disc. %</div><div class="field">20</div></div>
<div><div class="field-label">MOT Disc. %</div><div class="field">-</div></div>
</div>
<div class="accessories">
<div class="accessories-head">
<div style="font-weight:600;font-size:14px">Accessories</div>
<div style="text-align:right;font-size:14px">Accessories preview : <strong data-accessories-preview-amount="">$0.00</strong></div>
</div>
<div class="accessories-list">
<div class="accessories-items"></div>
<div class="accessories-empty">No accessories. Add a row</div>
</div>
<div class="accessory-tools"><div class="tinybox"><input data-accessory-discount-input="" max="100" min="0" type="number" value="20"/> <span>%</span></div><button class="btn" onclick="addAccessoryRow(this)" type="button">Add row</button></div>
</div>
</div>
<div>
<div class="summary-card">
<div style="font-size:14px">
<div class="summary-row"><span>Blinds</span><span>$1,642.20</span></div>
<div class="summary-row"><span>Surcharge</span><span>$145.20</span></div>
<div class="summary-row zero"><span>Option</span><span>$0.00</span></div>
</div>
<div class="summary-sep"></div>
<div>
<div class="summary-row"><span>Subtotal</span><span>$1,787.40</span></div>
<div class="summary-row"><span>Motor</span><span>$570.00</span></div>
<div class="summary-row zero"><span>Fee (Install + Extra)</span><span>$0.00</span></div>
<div class="summary-row zero"><span>Accessories</span><span data-summary-accessories-amount="">$0.00</span></div>
<div class="summary-row"><span>Discount</span><span>-$570</span></div>
</div>
<div class="summary-sep"></div>
<div class="summary-row summary-total"><span>Total</span><span>$1,787.00</span></div>
<div class="summary-row" style="font-size:16px;font-weight:600"><span>Gst</span><span>$89.37</span></div>
<div class="summary-row summary-final"><span>Total</span><span>$1,876.37</span></div>
</div>
<div class="info-box" style="margin-top:16px">Information</div>
</div>
</div>
</div>
</div>
    ...
    function toggleCheck(el){
      ...
      if(label.includes('Reach cord')){
        const valueEl = el.nextElementSibling;
        if(valueEl && valueEl.classList.contains('inline-value')){
          valueEl.classList.toggle('hidden', !el.classList.contains('checked'));
        }
      }

      if(el.hasAttribute('data-chain-weight-toggle')){
        const card = el.closest('.card');
        const prefix = card ? card.querySelector('[data-length-prefix]') : null;
        const lengthField = card ? card.querySelector('.length-field') : null;
        if(prefix){
          const isOn = el.classList.contains('checked');
          prefix.classList.toggle('hidden', !isOn);
          if(lengthField){
            lengthField.classList.toggle('has-prefix', isOn);
          }
        }
      }
    }
    ...
    function toggleClientMenu(el){
      ...
      const menu = wrapper.querySelector('.client-menu');
      if(menu) menu.classList.toggle('hidden');
    }

    function toggleDealerMenu(el){
      const wrapper = el.parentElement;
      const menu = wrapper.querySelector('.client-menu');
      if(menu) menu.classList.toggle('hidden');
    }

    function selectDealer(el, dealerName){
      const wrapper = el.closest('.col-2');
      if(!wrapper) return;
      const menu = wrapper.querySelector('.client-menu');
      const fieldText = wrapper.querySelector('.field span');
      if(fieldText){
        fieldText.textContent = dealerName;
        fieldText.classList.remove('placeholder');
      }
      if(menu) menu.classList.add('hidden');
    }

    function toggleTypeMenu(el){
      const wrapper = el.parentElement;
      const menu = wrapper.querySelector('.client-menu');
      if(menu) menu.classList.toggle('hidden');
    }
    ...
    function toggleRoomMenu(el){
      const wrapper = el.closest('.col-3');
      if(!wrapper) return;
      const menu = wrapper.querySelector('.client-menu');
      if(menu) menu.classList.toggle('hidden');
    }

    function renderRoomValue(wrapper, value = '', isCustom = false){
      const valueBox = wrapper.querySelector('.room-type-value');
      if(!valueBox) return;

      if(isCustom){
        valueBox.innerHTML = '<input data-room-input type="text" placeholder="Custom Room" />';
        const input = valueBox.querySelector('[data-room-input]');
        if(input){
          input.focus();
          ...
          input.addEventListener('blur', () => {
            ...
            if(nextValue){
              renderRoomValue(wrapper, nextValue, false);
            } else {
              renderRoomValue(wrapper, '', false);
            }
          }, { once:true });
        }
        return;
      ...
      if(!value){
        valueBox.innerHTML = '<span data-room-display class="placeholder">Select Room</span>';
        return;
      }

      valueBox.innerHTML = \`<span data-room-display>\${value}</span>\`;
    }

    function selectRoom(el, value){
      const wrapper = el.closest('.col-3');
      if(!wrapper) return;

      const menu = wrapper.querySelector('.client-menu');
      const windowCard = el.closest('.card');
      const windowIndex = windowCard
        ? Array.from(document.querySelectorAll('.card'))
            .filter(function(card){ return card.querySelector('.window-head'); })
            .indexOf(windowCard) + 1
        : null;

      if(value === 'custom'){
        renderRoomValue(wrapper, '', true);

        const input = wrapper.querySelector('[data-room-input]');
        if(input){
          input.addEventListener('blur', function () {
            if(windowIndex){
              updateWindowTitleMeta(windowIndex);
            }
          }, { once: true });
        }
      } else {
        renderRoomValue(wrapper, value, false);
    ...
    function toggleGroupMenu(el){
      const wrapper = el.parentElement;
      const menu = wrapper.querySelector('.client-menu');
      if(menu) menu.classList.toggle('hidden');
    }

    function selectGroup(el, value){
      const wrapper = el.closest('.col-1');
      if(!wrapper) return;
      const menu = wrapper.querySelector('.client-menu');
      const fieldText = wrapper.querySelector('.field span');
      if(fieldText){
    ...
    function toggleCtrlSideMenu(el){
      const wrapper = el.parentElement;
      const menu = wrapper.querySelector('.client-menu');
      if(menu) menu.classList.toggle('hidden');
    }

    function toggleSplitCtrlMenu(el, evt){
      const e = evt || window.event;
      if(e){
        e.preventDefault();
        e.stopPropagation();
      }
      const wrapper = el.closest('.split-seg');
      if(!wrapper) return;
      const menu = wrapper.querySelector('.split-select-menu');
      if(!menu) return;

      const willOpen = menu.classList.contains('hidden');
      document.querySelectorAll('.split-select-menu').forEach((m) => {
    ...
    function selectSplitCtrl(el, value, evt){
      const e = evt || window.event;
      if(e) e.stopPropagation();
      const wrapper = el.closest('.split-seg');
      if(!wrapper) return;
      const display = wrapper.querySelector('.split-select-display');
      const menu = wrapper.querySelector('.split-select-menu');
      if(display) display.textContent = value;
      if(menu) menu.classList.add('hidden');
    }

    function selectCtrlSide(el, sideValue){
      const wrapper = el.closest('.col-1');
      if(!wrapper) return;
      const menu = wrapper.querySelector('.client-menu');
      const fieldText = wrapper.querySelector('.field span');
      if(fieldText){
        fieldText.textContent = sideValue;
        fieldText.classList.remove('placeholder');
      }
      if(menu) menu.classList.add('hidden');
    }

    function toggleLocationMenu(el){
      const wrapper = el.parentElement;
      const menu = wrapper.querySelector('.client-menu');
      if(menu) menu.classList.toggle('hidden');
    }

    function selectLocation(el, value){
      const wrapper = el.closest('.col-1');
      if(!wrapper) return;
      const menu = wrapper.querySelector('.client-menu');
      const field = wrapper.querySelector('.field');
      const windowCard = el.closest('.card');
      const windowIndex = windowCard ? Array.from(document.querySelectorAll('.card')).filter((card) => card.querySelector('.window-head')).indexOf(windowCard) + 1 : null;

      if(value === 'custom'){
        field.innerHTML = '<input data-location-input type="text" placeholder="Floor" onclick="event.stopPropagation()" oninput="updateWindowTitleMeta(' + (windowIndex || 1) + ')" />';
        const input = field.querySelector('[data-location-input]');
        if(input){
          input.focus();
          input.addEventListener('keydown', (event) => {
    ...
    function toggleRailColorMenu(el, evt){
      const e = evt || window.event;
      if(e) e.stopPropagation();
      const wrapper = el.closest('.col-3');
      if(!wrapper) return;
    ...
    function selectRailColor(el, value){
      const wrapper = el.closest('.col-3');
      if(!wrapper) return;
      const menu = wrapper.querySelector('.client-menu');
      const colorSeg = wrapper.querySelector('.rail-seg.clickable');
      if(colorSeg){
        colorSeg.textContent = value;
        colorSeg.classList.remove('placeholder');
      }
      if(menu) menu.classList.add('hidden');
    }

    function toggleMountTypeMenu(el){
      const wrapper = el.closest('.col-1');
      if(!wrapper) return;
      const menu = wrapper.querySelector('.client-menu');
      if(menu) menu.classList.toggle('hidden');
    ...
    function renderMountTypeValue(wrapper, value = '', isCustom = false){
      const valueBox = wrapper.querySelector('[data-mount-type-value]');
      if(!valueBox) return;

      if(isCustom){
        valueBox.innerHTML = '<input data-mount-type-input type="text" placeholder="Custom" />';
        const input = valueBox.querySelector('[data-mount-type-input]');
        if(input){
          input.focus();
          input.addEventListener('click', (event) => {
            event.stopPropagation();
      ...
      if(!value){
        valueBox.innerHTML = '<span data-mount-type-display class="placeholder">Select</span>';
        return;
      }

      valueBox.innerHTML = \`<span data-mount-type-display>\${value}</span>\`;
    }

    function toggleConfigMenu(el){
      const wrapper = el.parentElement;
      const menu = wrapper.querySelector('.client-menu');
      if(menu) menu.classList.toggle('hidden');
    }

    function selectConfig(el, value){
      const wrapper = el.closest('.col-1');
      if(!wrapper) return;
      const menu = wrapper.querySelector('.client-menu');
      const fieldText = wrapper.querySelector('.field span');
      ...
      const card = el.closest('.card');
      const splitRow = card ? card.querySelector('.split-row') : null;

      if(value === 'Multi' || value === 'Linked'){
        if(splitRow) splitRow.classList.remove('hidden');
        if(typeof selectUnit === 'function'){
          selectUnit('mm');
        }
        syncSplitAutoForCard(card);
      } else {
        if(splitRow) splitRow.classList.add('hidden');
        clearSplitAutoState(card);
      }

      if(menu) menu.classList.add('hidden');
    }

    function changeSplit(el, delta){
      const container = el.closest('[data-split-container]');
      if(!container) return;

      const fieldsWrap = container.querySelector('[data-split-fields]');
      if(!fieldsWrap) return;

      const currentItems = Array.from(fieldsWrap.querySelectorAll('.split-item')).map((item) => {
        const input = item.querySelector('.split-mm-input');
        const ctrl = item.querySelector('.split-select-display');
        return {
          value: input ? input.value : '',
          isAuto: input ? input.dataset.autoFilled === 'true' : false,
          ctrl: ctrl ? (ctrl.textContent.trim() || 'None') : 'None'
        };
      });

      const currentCount = currentItems.length;
      let count = currentCount + delta;
      if(count < 2) count = 2;
      if(count > 5) count = 5;
      ...
      if(count > currentCount){
        nextItems = currentItems.map((item) => ({ ...item, forceAuto: false }));
        while(nextItems.length < count){
          nextItems.push({ value: '', isAuto: false, ctrl: 'None', forceAuto: false });
        }
      } else {
        nextItems = [...currentItems];
        while(nextItems.length > count){
          let removeIndex = nextItems.findIndex((item, index) => (item.isAuto || String(item.value).trim() === '') && index !== nextItems.length - 1);
          if(removeIndex === -1) removeIndex = nextItems.findIndex((item) => item.isAuto || String(item.value).trim() === '');
          if(removeIndex === -1) removeIndex = nextItems.length - 1;
          nextItems.splice(removeIndex, 1);
        }

        nextItems = nextItems.map((item, index) => ({
          value: index === nextItems.length - 1 ? '' : (item.isAuto ? '' : item.value),
          isAuto: false,
          ctrl: item.ctrl || 'None',
          forceAuto: index === nextItems.length - 1
        }));
      }
      ...
      nextItems.forEach((item, index) => {
        ...
        let label = \`\${count}/\${i}\`;
        if(i === 1) label += ' (Left)';
        if(i === count) label += ' (Right)';

        const safeValue = item.value === '0' ? '' : (item.value ?? '');
        const safeCtrl = item.ctrl || 'None';
        const forceAutoAttr = item.forceAuto ? ' data-force-auto="true"' : '';
        ...
        div.innerHTML = \`
          ...
          <div class="split-combo">
            <div class="split-seg"><input class="split-mm-input" type="number" placeholder="mm" value="\${safeValue}"\${forceAutoAttr} /></div>
            <div class="split-seg">
              <div class="split-select-display" onclick="toggleSplitCtrlMenu(this, event)">\${safeCtrl}</div>
              <div class="client-menu split-select-menu hidden">
                <div class="client-option" onclick="selectSplitCtrl(this,'None', event)">None</div>
                <div class="client-option" onclick="selectSplitCtrl(this,'L', event)">L</div>
                <div class="client-option" onclick="selectSplitCtrl(this,'R', event)">R</div>
      ...
      syncSplitAutoForCard(container.closest('.card'));
    }

    function getCardWidthMm(card){
      if(!card) return null;
      const widthField = card.querySelector('.dimension-field[data-dimension="w"]');
      if(!widthField) return null;
      return getMmValue(widthField);
    }

    function clearSplitAutoState(card){
      if(!card) return;
      card.querySelectorAll('.split-mm-input').forEach((input) => {
        input.classList.remove('split-input-auto');
      });
    }

    function syncSplitAutoForCard(card){
      if(!card) return;
      const splitRow = card.querySelector('.split-row');
      if(!splitRow || splitRow.classList.contains('hidden')) return;

      const inputs = Array.from(splitRow.querySelectorAll('.split-mm-input'));
      if(!inputs.length) return;

      clearSplitAutoState(card);

      const widthMm = getCardWidthMm(card);
      if(!Number.isFinite(widthMm) || widthMm === null) return;

      const forcedAutoInput = inputs.find((input) => input.dataset.forceAuto === 'true');
      const blankInputs = inputs.filter((input) => String(input.value ?? '').trim() === '');
      const autoInputs = inputs.filter((input) => input.dataset.autoFilled === 'true');
      const filledInputs = inputs.filter((input) => String(input.value ?? '').trim() !== '' && input.dataset.autoFilled !== 'true');

      let autoInput = null;

      if(forcedAutoInput && filledInputs.length > 0){
        autoInput = forcedAutoInput;
      } else if(blankInputs.length === 1 && filledInputs.length > 0){
        autoInput = blankInputs[0];
      } else if(autoInputs.length === 1 && filledInputs.length > 0){
        autoInput = autoInputs[0];
      }
      ...
      if(!autoInput){
        inputs.forEach((input) => {
          ...
          if(blankInputs.length !== 1){
            delete input.dataset.forceAuto;
          }
        });
        return;
      }

      const filledTotal = inputs.reduce((sum, input) => {
        if(input === autoInput) return sum;
      ...
      const remaining = Math.max(0, Math.round(widthMm - filledTotal));
      autoInput.value = remaining === 0 ? '' : String(remaining);
      autoInput.dataset.autoFilled = 'true';
      autoInput.classList.add('split-input-auto');
    ...
    function selectMountType(el, value){
      const wrapper = el.closest('.col-1');
      if(!wrapper) return;
      const menu = wrapper.querySelector('.client-menu');

      if(value === 'custom'){
        renderMountTypeValue(wrapper, '', true);
      } else {
        renderMountTypeValue(wrapper, value, false);
      }
    ...
    function buildFractionOptions(){
      let opts = '<option value="">—</option>';
      for(let i = 1; i <= 31; i += 1){
        opts += \`<option value="\${i}">\${simplify(i, 32)}</option>\`;
      }
      return opts;
    }

    function buildInchOptions(){
      let html = '';
    ...
    function inches32ToMmValue(total32){
      return (total32 / 32) * 25.4;
    }

    function mmToExact32(mm){
      const value = parseFloat(mm);
      if(!Number.isFinite(value) || value <= 0) return null;
      return Math.round((value / 25.4) * 32);
    }

    function formatMmValue(mm){
      if(mm === null || mm === undefined) return '';
      return String(Math.round(mm));
    }

    function decompose32(total32){
      const safe = Math.max(0, Math.floor(total32 || 0));
      return {
        whole: Math.floor(safe / 32),
        frac32: safe % 32,
      };
    }

    function decompose32Ft(total32){
      const safe = Math.max(0, Math.floor(total32 || 0));
      const feet = Math.floor(safe / (12 * 32));
      const rem = safe - feet * 12 * 32;
      return {
        feet,
        inches: Math.floor(rem / 32),
        frac32: rem % 32,
      };
    }

    function getMmValue(field){
      const raw = field.dataset.mmValue;
      if(raw === undefined || raw === '') return null;
      const value = parseFloat(raw);
      return Number.isFinite(value) && value >= 0 ? value : null;
    }

    function setMmValue(field, mm){
      if(mm === null || mm === undefined || mm === ''){
        delete field.dataset.mmValue;
        return;
      }
      ...
      field.dataset.mmValue = String(numeric);
    }

    function renderDimensionFields(unit){
      const fracOpts = buildFractionOptions();
      const inchOpts = buildInchOptions();

      document.querySelectorAll('.dimension-field').forEach((field) => {
        const mmValue = getMmValue(field);
        const hasVal = mmValue !== null;
        const exact32 = hasVal ? mmToExact32(mmValue) : null;

        if(unit === 'mm'){
          field.innerHTML = \`
            <div class="dimension-split mm">
              <div class="dimension-segment">
                <input class="dimension-control" data-role="mm" type="number" step="1" value="\${hasVal ? formatMmValue(mmValue) : ''}" />
              </div>
            </div>\`;
          return;
        }
        ...
        if(unit === 'inch'){
          const parts = decompose32(hasVal ? exact32 : 0);
          field.innerHTML = \`
            <div class="dimension-split inch">
              <div class="dimension-segment">
                <input class="dimension-control" data-role="inch-whole" type="number" step="1" value="\${hasVal ? parts.whole : ''}" />
              </div>
              <div class="dimension-segment">
                <select class="dimension-control select" data-role="inch-fraction">\${fracOpts}</select>
              </div>
            </div>\`;
          const sel = field.querySelector('[data-role="inch-fraction"]');
          if(sel && hasVal){
            sel.value = parts.frac32 ? String(parts.frac32) : '';
          }
          return;
        }

        const parts = decompose32Ft(hasVal ? exact32 : 0);
        field.innerHTML = \`
          <div class="dimension-split ft-inch">
            <div class="dimension-segment">
              <input class="dimension-control" data-role="ft" type="number" step="1" value="\${hasVal ? parts.feet : ''}" />
            </div>
            <div class="dimension-segment">
              <select class="dimension-control select" data-role="ft-inch-whole">\${inchOpts}</select>
            </div>
            <div class="dimension-segment">
              <select class="dimension-control select" data-role="ft-inch-fraction">\${fracOpts}</select>
            </div>
          </div>\`;

        const inchSel = field.querySelector('[data-role="ft-inch-whole"]');
        const fracSel = field.querySelector('[data-role="ft-inch-fraction"]');
        if(inchSel && hasVal){
          inchSel.value = String(parts.inches);
        }
        if(fracSel && hasVal){
          fracSel.value = parts.frac32 ? String(parts.frac32) : '';
        }
      });
    }

    function updateFieldMmFromControls(field){
      const unit = document.getElementById('unitLabel').textContent.trim();

      if(unit === 'mm'){
        const raw = field.querySelector('[data-role="mm"]')?.value ?? '';
        if(raw.trim() === ''){
          setMmValue(field, null);
          updateAllWindowSqft();
          if(field.dataset.dimension === 'w'){
            syncSplitAutoForCard(field.closest('.card'));
          }
          return;
        }
        setMmValue(field, parseFloat(raw));
        updateAllWindowSqft();
        if(field.dataset.dimension === 'w'){
          syncSplitAutoForCard(field.closest('.card'));
        }
      ...
      if(unit === 'inch'){
        const wholeRaw = field.querySelector('[data-role="inch-whole"]')?.value ?? '';
        const fracRaw = field.querySelector('[data-role="inch-fraction"]')?.value ?? '';
        if(wholeRaw.trim() === '' && fracRaw === ''){
          setMmValue(field, null);
          updateAllWindowSqft();
          if(field.dataset.dimension === 'w'){
            syncSplitAutoForCard(field.closest('.card'));
        ...
        const frac32 = parseInt(fracRaw || '0', 10);
        const total32 = Math.max(0, (whole || 0) * 32 + (frac32 || 0));
        setMmValue(field, inches32ToMmValue(total32));
        updateAllWindowSqft();
        if(field.dataset.dimension === 'w'){
          syncSplitAutoForCard(field.closest('.card'));
        }
      ...
      const feetRaw = field.querySelector('[data-role="ft"]')?.value ?? '';
      const inchRaw = field.querySelector('[data-role="ft-inch-whole"]')?.value ?? '0';
      const fracRaw = field.querySelector('[data-role="ft-inch-fraction"]')?.value ?? '';
      if(feetRaw.trim() === '' && inchRaw === '0' && fracRaw === ''){
        setMmValue(field, null);
        updateAllWindowSqft();
        if(field.dataset.dimension === 'w'){
          syncSplitAutoForCard(field.closest('.card'));
      ...
      const inchesWhole = parseInt(inchRaw || '0', 10);
      const frac32 = parseInt(fracRaw || '0', 10);
      const total32 = Math.max(0, (feet || 0) * 12 * 32 + (inchesWhole || 0) * 32 + (frac32 || 0));
      setMmValue(field, inches32ToMmValue(total32));
      updateAllWindowSqft();
      if(field.dataset.dimension === 'w'){
        syncSplitAutoForCard(field.closest('.card'));
    ...
    function selectUnit(unit){
      ...
      document.querySelectorAll('.field-label').forEach((l) => {
        if(l.textContent.startsWith('W (')) l.textContent = \`W (\${unit})\`;
        if(l.textContent.startsWith('H (')) l.textContent = \`H (\${unit})\`;
      });

      renderDimensionFields(unit);
      updateAllWindowSqft();
    ...
    function getWindowFloorValue(index){
      const cards = Array.from(document.querySelectorAll('.card')).filter((card) => card.querySelector('.window-head'));
      const card = cards[index - 1];
      if(!card) return '';
      const field = card.querySelector('.col-1 .field');
      if(!field) return '';
      const input = field.querySelector('[data-location-input]');
      if(input) return input.value.trim();
      const span = field.querySelector('span');
      if(!span) return '';
      return span.classList.contains('placeholder') ? '' : span.textContent.trim();
    }

    function reindexWindowCards(){
      const windowCards = Array.from(document.querySelectorAll('.card')).filter((card) => card.querySelector('.window-head'));

      windowCards.forEach((card, index) => {
        const newIndex = index + 1;
        const labelEl = card.querySelector('[data-window-label]');
        const metaEl = card.querySelector('[data-window-meta]');
        const sidemarkInput = card.querySelector('[data-sidemark-input]');
        const sqftEl = card.querySelector('[data-window-sqft]');

        if(labelEl) labelEl.textContent = \`Window #\${newIndex}\`;
        if(metaEl) metaEl.setAttribute('data-window-meta', String(newIndex));
        if(sidemarkInput){
          sidemarkInput.setAttribute('data-sidemark-input', String(newIndex));
          sidemarkInput.setAttribute('oninput', \`updateWindowTitleMeta(\${newIndex})\`);
        }
        if(sqftEl) sqftEl.setAttribute('data-window-sqft', String(newIndex));
      });

      windowCards.forEach((_, index) => updateWindowTitleMeta(index + 1));
      updateAllWindowSqft();
    }

    function updateWindowCardActionButtons(){
      const windowCards = Array.from(document.querySelectorAll('.card')).filter((card) => card.querySelector('.window-head'));
      const protectedSampleCount = 3;
      const workCardCount = Math.max(windowCards.length - protectedSampleCount, 1);

      windowCards.forEach((card, index) => {
        const buttons = card.querySelectorAll('.window-footer .buttons .btn');
        const duplicateBtn = buttons[0];
        const deleteBtn = buttons[1];
        const isWorkCard = index < workCardCount;
        const canDelete = isWorkCard && workCardCount > 1;

        if(duplicateBtn){
          duplicateBtn.disabled = !isWorkCard;
          duplicateBtn.style.opacity = isWorkCard ? '1' : '0.45';
          duplicateBtn.style.cursor = isWorkCard ? 'pointer' : 'not-allowed';
        }

        if(deleteBtn){
          deleteBtn.disabled = !canDelete;
          deleteBtn.style.opacity = canDelete ? '1' : '0.45';
          deleteBtn.style.cursor = canDelete ? 'pointer' : 'not-allowed';
        }
      });
    }

    function duplicateWindowCard(el){
      if(el.disabled) return;
      const card = el.closest('.card');
      if(!card || !card.querySelector('.window-head')) return;

      const clone = card.cloneNode(true);

      clone.querySelectorAll('.client-menu').forEach((menu) => menu.classList.add('hidden'));

      clone.querySelectorAll('[data-mount-type-input]').forEach((input) => {
        const wrapper = input.closest('.col-1');
        if(wrapper) renderMountTypeValue(wrapper, '', false);
      });

      const configWrapper = Array.from(clone.querySelectorAll('.col-1')).find(col => col.querySelector('.field-label')?.textContent?.trim() === 'Config');
      if(configWrapper){
        const span = configWrapper.querySelector('.field span');
        if(span){
      ...
      const splitRow = clone.querySelector('.split-row');
      if(splitRow){
        splitRow.classList.add('hidden');
        splitRow.querySelectorAll('.split-mm-input').forEach(input => {
          input.value = '';
          input.classList.remove('split-input-auto');
          delete input.dataset.autoFilled;
        });
      ...
      reindexWindowCards();
      updateWindowCardActionButtons();
    }

    function deleteWindowCard(el){
      if(el.disabled) return;
      const windowCards = Array.from(document.querySelectorAll('.card')).filter((card) => card.querySelector('.window-head'));
      const protectedSampleCount = 3;
      const workCardCount = Math.max(windowCards.length - protectedSampleCount, 1);
      if(workCardCount <= 1) return;

      const card = el.closest('.card');
      if(!card || !card.querySelector('.window-head')) return;

      const cardIndex = windowCards.indexOf(card);
      if(cardIndex < 0 || cardIndex >= workCardCount) return;
    ...
    function updateWindowTitleMeta(index){
      const metaEl = document.querySelector('[data-window-meta="' + index + '"]');
      if(!metaEl) return;

      const cards = Array.from(document.querySelectorAll('.card')).filter(function(card){
        return card.querySelector('.window-head');
      });
      ...
      const floor = getWindowFloorValue(index);

      const roomInput = card.querySelector('[data-room-input]');
      const roomDisplay = card.querySelector('[data-room-display]');
      const sidemarkInput = card.querySelector('[data-sidemark-input="' + index + '"]');

      const room = roomInput
        ? roomInput.value.trim()
        : (roomDisplay && !roomDisplay.classList.contains('placeholder')
            ? roomDisplay.textContent.trim()
            : '');

      const sidemark = sidemarkInput ? sidemarkInput.value.trim() : '';

      const left = [floor, room].filter(Boolean).join(' ');
      let meta = '';
      ...
      metaEl.innerHTML = meta ? ' ' + meta : '';
    }
    function calculateCeilingSqftFromMm(widthMm, heightMm){
    ...
    function updateAllWindowSqft(){
      const windowCards = Array.from(document.querySelectorAll('.card')).filter((card) => card.querySelector('.window-head'));
      windowCards.forEach((card, index) => {
        const sqftEl = card.querySelector(\`[data-window-sqft="\${index + 1}"]\`);
        const dims = card.querySelectorAll('.dimension-field');
        if(!sqftEl || dims.length < 2){
          return;
        }
        const widthMm = getMmValue(dims[0]);
        const heightMm = getMmValue(dims[1]);
        const sqft = calculateCeilingSqftFromMm(widthMm, heightMm);
        sqftEl.textContent = \`Sqft \${sqft}\`;
      });
    }

    document.addEventListener('input', (e) => {
      if(e.target.classList.contains('dimension-control')){
        const field = e.target.closest('.dimension-field');
        if(field){
          updateFieldMmFromControls(field);
        }
        return;
      }

      if(e.target.classList.contains('split-mm-input')){
        const currentInput = e.target;
        if(currentInput.dataset.autoFilled === 'true'){
          delete currentInput.dataset.autoFilled;
          delete currentInput.dataset.forceAuto;
          currentInput.classList.remove('split-input-auto');
        }
        syncSplitAutoForCard(currentInput.closest('.card'));
        return;
      }

      if(
        e.target.matches('[data-accessory-qty]') ||
        e.target.matches('[data-accessory-price]') ||
        e.target.matches('[data-accessory-discount-input]')
      ){
        updateAccessoriesTotals(e.target.closest('.accessories'));
      }
    });

    document.addEventListener('change', (e) => {
      if(!e.target.classList.contains('dimension-control')) return;
      const field = e.target.closest('.dimension-field');
      if(field){
        updateFieldMmFromControls(field);
      }
    ...
    document.addEventListener('click', (e) => {
      ...
      if(unitMenu && !unitMenu.contains(e.target) && !dropdown){
        unitMenu.classList.add('hidden');
      }

      document.querySelectorAll('.client-menu').forEach((clientMenu) => {
        if(clientMenu.classList.contains('split-select-menu')){
          if(!clientMenu.contains(e.target) && !e.target.closest('.split-select-display')){
            clientMenu.classList.add('hidden');
          }
          return;
        }

        const parent = clientMenu.parentElement;
    ...
    function setScreenMode(mode){
      const allowedModes = ['newQuote', 'quoteView'];
      const nextMode = allowedModes.includes(mode) ? mode : 'newQuote';
      document.body.setAttribute('data-screen-mode', nextMode);
    }

    function toggleInformationCard(){
      const cardEl = document.getElementById('informationCard');
      const bodyEl = document.querySelector('#informationCard .info-card-body-hidden');
      const iconEl = document.getElementById('infoToggleIcon');
      if(!bodyEl || !cardEl) return;
      const isHidden = getComputedStyle(bodyEl).display === 'none';
      bodyEl.style.display = isHidden ? 'grid' : 'none';
      cardEl.classList.toggle('is-collapsed', !isHidden);
      if(iconEl){
    ...
    function getAccessoryDiscountPercent(card){
      const input = card.querySelector('[data-accessory-discount-input]');
      if(!input) return 0;
    ...
    function updateAccessoriesTotals(card){
      if(!card) return;
      const rows = Array.from(card.querySelectorAll('.accessory-row'));
      const subtotal = rows.reduce((sum, row) => {
        const qty = parseFloat(row.querySelector('[data-accessory-qty]')?.value || '0');
        const price = parseFloat(row.querySelector('[data-accessory-price]')?.value || '0');
        const safeQty = Number.isFinite(qty) ? qty : 0;
        const safePrice = Number.isFinite(price) ? price : 0;
        return sum + (safeQty * safePrice);
      }, 0);

      const discountPercent = getAccessoryDiscountPercent(card);
      const previewTotal = subtotal * (1 - discountPercent / 100);

      const previewEl = card.querySelector('[data-accessories-preview-amount]');
      if(previewEl) previewEl.textContent = formatCurrency(previewTotal);

      const summaryEl = document.querySelector('[data-summary-accessories-amount]');
      if(summaryEl) summaryEl.textContent = formatCurrency(previewTotal);
    }

    function updateAccessoriesEmptyState(){
      document.querySelectorAll('.accessories').forEach((card) => {
        const itemsWrap = card.querySelector('.accessories-items');
        const emptyEl = card.querySelector('.accessories-empty');
        if(!itemsWrap || !emptyEl) return;

        const hasItems = itemsWrap.children.length > 0;
        emptyEl.classList.toggle('hidden', hasItems);
      });
    }

    function addAccessoryRow(el){
      const card = el.closest('.accessories');
      if(!card) return;
      const itemsWrap = card.querySelector('.accessories-items');
      if(!itemsWrap) return;
      ...
      row.innerHTML = \`
        <div class="field"><input type="text" placeholder="Accessory item" data-accessory-item /></div>
        <div class="field"><input type="number" min="0" step="1" value="1" data-accessory-qty /></div>
        <div class="field currency-field"><input type="number" min="0" step="0.01" value="0" data-accessory-price /></div>
        <button class="btn btn-danger" type="button" onclick="removeAccessoryRow(this)">Del</button>
      \`;
      itemsWrap.appendChild(row);
      updateAccessoriesEmptyState();
      updateAccessoriesTotals(document.querySelector('.accessories'));
      updateAccessoriesTotals(card);
    }

    function removeAccessoryRow(el){
      const row = el.closest('.accessory-row');
      const card = el.closest('.accessories');
      if(row) row.remove();
      updateAccessoriesEmptyState();
      updateAccessoriesTotals(card);
  ...
  if(unitDropdown){
    unitDropdown.addEventListener('click', toggleUnitMenu);
  }

  if(unitMenu){
    unitMenu.querySelectorAll('[data-unit-option]').forEach((opt) => {
      opt.addEventListener('click', () => selectUnit(opt.dataset.unitOption));
    });
  }

  setScreenMode(document.body.getAttribute('data-screen-mode') || 'newQuote');
  selectUnit(document.getElementById('unitLabel').textContent.trim());
  updateAllWindowSqft();
  reindexWindowCards();
  updateWindowCardActionButtons();

  const chainWeightToggle = document.querySelector('[data-chain-weight-toggle]');
  const prefix = document.querySelector('[data-length-prefix]');
  const lengthField = document.querySelector('.length-field');
  if(chainWeightToggle && prefix){
    const isOn = chainWeightToggle.classList.contains('checked');
    prefix.classList.toggle('hidden', !isOn);
    if(lengthField){
      lengthField.classList.toggle('has-prefix', isOn);
    }
  ...
  document.querySelectorAll('.card').forEach((card) => {
    try {
      ...
      console.error('split auto init error', err);
    }
  });
...
initMeasurePage();
  `;function b({onOpenMainPage:e,onOpenMeasurePage:t,onOpenQuotesPage:n,onOpenOrdersPage:r,onOpenClientsPage:i,onOpenResourcesPage:a,onOpenAdminPage:o}){return(0,l.useEffect)(()=>{let s=document.createElement(`script`);s.type=`text/javascript`,s.dataset.wincoMeasurePage=`true`,s.text=y,document.body.appendChild(s);let c=(()=>{let s=document.querySelector(`.measure-page`);if(!s)return()=>{};let c=s.querySelectorAll(`.top-nav-left .nav-item, .top-nav-left > div`),l=[];return c.forEach(s=>{let c=s.textContent.trim(),u=null;if(c===`Charles / Winco`&&(u=e),c===`Measure`&&(u=t),c===`Quotes`&&(u=n),c===`Orders`&&(u=r),c===`Clients`&&(u=i),c===`Resources`&&(u=a),c===`Admin`&&(u=o),u){let e=()=>u();s.style.cursor=`pointer`,s.addEventListener(`click`,e),l.push([s,e])}}),()=>{l.forEach(([e,t])=>{e.removeEventListener(`click`,t)})}})(),l=()=>{let e=document.getElementById(`unitDropdown`),t=document.getElementById(`unitMenu`),n=document.getElementById(`unitLabel`);if(!e||!t||!n)return()=>{};let r=e=>{e.stopPropagation(),t.classList.toggle(`hidden`)},i=n=>{!t.contains(n.target)&&!e.contains(n.target)&&t.classList.add(`hidden`)},a=[];return t.querySelectorAll(`[data-unit-option]`).forEach(e=>{let r=r=>{r.stopPropagation();let i=e.dataset.unitOption;i&&(n.textContent=i,document.querySelectorAll(`.field-label`).forEach(e=>{e.textContent.startsWith(`W (`)&&(e.textContent=`W (${i})`),e.textContent.startsWith(`H (`)&&(e.textContent=`H (${i})`)}),typeof window.selectUnit==`function`&&window.selectUnit(i),t.classList.add(`hidden`))};e.addEventListener(`click`,r),a.push([e,r])}),e.addEventListener(`click`,r),document.addEventListener(`click`,i),()=>{e.removeEventListener(`click`,r),document.removeEventListener(`click`,i),a.forEach(([e,t])=>e.removeEventListener(`click`,t))}},u=window.setTimeout(()=>{typeof window.initMeasurePage==`function`&&window.initMeasurePage()},0),d=l();return()=>{typeof c==`function`&&c(),window.clearTimeout(u),d(),s.parentNode&&s.parentNode.removeChild(s)}},[]),(0,p.jsx)(`div`,{className:`measure-page`,"data-screen-mode":`newQuote`,dangerouslySetInnerHTML:{__html:v}})}var x=`<div class="app-preview">
  <div class="ipad-stage">
    <div class="app-frame">
      <nav class="topbar">
        <div class="topbar-inner">
          <div class="topbar-left">
            <div class="nav-item account">Charles / Winco</div>
            <div class="nav-separator">|</div>
            <div class="nav-item">Measure</div>
            <div class="nav-item current">Quotes</div>
            <div class="nav-item">Orders</div>
            <div class="nav-item">Clients</div>
            <div class="nav-item">Resources</div>
            <div class="nav-item">Admin</div>
        ...
        <section class="page-blank">
          <div class="quotes-shell">
            <div class="quotes-header">
              ...
              <div class="quotes-header-tools">
                <div class="quotes-view-switch">
                  <div class="quotes-view-tab current">Active</div>
                  <div class="quotes-view-tab">Deleted</div>
                </div>
                <div class="quotes-delete">Delete</div>
                <div class="quotes-search">
                  <input type="text" placeholder="Search" data-quotes-search-input />
                  <button type="button" class="quotes-search-clear hidden" data-quotes-search-clear aria-label="Clear search">×</button>
                </div>
              </div>
            </div>

            <div class="quotes-table">
              <div class="quotes-table-head">
                <div class="quotes-cell quotes-check-cell"></div>
                <div class="quotes-cell">
                  <span class="quotes-sort-button">Quotes # <span class="quotes-sort-arrow">▾</span></span>
                </div>
                <div class="quotes-cell">Client</div>
                <div class="quotes-cell">Project / Tag</div>
                <div class="quotes-cell">Product</div>
                <div class="quotes-cell">Qty</div>
                <div class="quotes-cell">Total Price</div>
                <div class="quotes-cell">
                  <div class="quotes-head-filter active" onclick="toggleQuotesFilter(event)">
                    <span data-status-filter-label>Status</span>
                    <span class="quotes-sort-arrow">▾</span>
                    <div class="quotes-filter-menu">
                      <div class="quotes-filter-option current" onclick="selectQuotesFilter(event, 'All Status')">All Status</div>
                      <div class="quotes-filter-option" onclick="selectQuotesFilter(event, 'Draft')">Draft</div>
                      <div class="quotes-filter-option" onclick="selectQuotesFilter(event, 'Ordered')">Ordered</div>
                    </div>
                  </div>
                </div>
                <div class="quotes-cell">
                  <span class="quotes-sort-button active">Last updated <span class="quotes-sort-arrow">▾</span></span>
                </div>
              </div>

              <div class="quotes-row" data-status="draft" data-search="Q260412-01 Charles Kim Living Room Dual 1234 99 Ave NW Edmonton 780-555-0101 charles@example.com blind replacement main floor">
                <div class="quotes-cell quotes-check-cell"><span class="quotes-check"></span></div>
                <div class="quotes-cell">Q260412-01</div>
                <div class="quotes-cell">Charles</div>
                <div class="quotes-cell">Living Room</div>
                <div class="quotes-cell">Dual</div>
                <div class="quotes-cell">4</div>
                <div class="quotes-cell total">$1,876.37</div>
                <div class="quotes-cell status status-draft">Draft</div>
                <div class="quotes-cell muted">04/12/2026</div>
              </div>

              <div class="quotes-row" data-status="ordered" data-search="Q260411-07 Mina Kim Kitchen Dining Roller 88 Riverbend Gate SW Calgary 403-555-0118 mina@example.com condo kitchen order">
                <div class="quotes-cell quotes-check-cell"><span class="quotes-check"></span></div>
                <div class="quotes-cell">Q260411-07</div>
                <div class="quotes-cell">Mina Kim</div>
                <div class="quotes-cell">Kitchen / Dining</div>
                <div class="quotes-cell">Roller</div>
                <div class="quotes-cell">3</div>
                <div class="quotes-cell total">$1,240.00</div>
                <div class="quotes-cell status status-ordered">Ordered</div>
                <div class="quotes-cell muted">04/11/2026</div>
              </div>

              <div class="quotes-row" data-status="draft" data-search="Q260410-03 Dealer A Showhome Main Dual 25 Lakeview Drive Sherwood Park 587-555-0199 showhome@dealer-a.com builder showroom sample">
                <div class="quotes-cell quotes-check-cell"><span class="quotes-check"></span></div>
                <div class="quotes-cell">Q260410-03</div>
                <div class="quotes-cell">Dealer A</div>
                <div class="quotes-cell">Showhome - Main</div>
                <div class="quotes-cell">Dual</div>
                <div class="quotes-cell">8</div>
                <div class="quotes-cell total">$3,820.50</div>
                <div class="quotes-cell status status-draft">Draft</div>
                <div class="quotes-cell muted">04/10/2026</div>
              </div>
            </div>
          </div>
        </section>
...
function toggleQuotesFilter(event) {
  event.stopPropagation();
  const filter = event.currentTarget;
  filter.classList.toggle('open');
}

function closeQuotesFilters() {
  document.querySelectorAll('.quotes-head-filter.open').forEach(function (filter) {
    filter.classList.remove('open');
  });
}

function updateQuotesSearchClear() {
  const input = document.querySelector('[data-quotes-search-input]');
  const clearBtn = document.querySelector('[data-quotes-search-clear]');
  if (!input || !clearBtn) return;
  const hasValue = input.value.trim() !== '';
  clearBtn.classList.toggle('hidden', !hasValue);
}

function getQuotesSearchValue() {
  const input = document.querySelector('[data-quotes-search-input]');
  return input ? input.value.trim().toLowerCase() : '';
}

function getCurrentQuotesStatusValue() {
  const current = document.querySelector('.quotes-filter-option.current');
  return current ? current.textContent.trim() : 'All Status';
}

function applyQuotesFilters(statusValue) {
  const normalizedStatus = String(statusValue || 'All Status').toLowerCase();
  const searchValue = getQuotesSearchValue();

  document.querySelectorAll('.quotes-row').forEach(function (row) {
    const rowStatus = String(row.dataset.status || '').toLowerCase();
    const rowSearch = String(row.dataset.search || '').toLowerCase();

    const statusMatch = normalizedStatus === 'all status' || rowStatus === normalizedStatus;
  ...
  updateQuotesSearchClear();
}

function selectQuotesFilter(event, value) {
  event.stopPropagation();
  const option = event.currentTarget;
  const filter = option.closest('.quotes-head-filter');
  if (!filter) return;

  filter.querySelectorAll('.quotes-filter-option').forEach(function (item) {
    item.classList.remove('current');
  });
  option.classList.add('current');

  const label = filter.querySelector('[data-status-filter-label]');
  if (label) {
    label.textContent = value === 'All Status' ? 'Status' : value;
  }

  applyQuotesFilters(value);
  closeQuotesFilters();
}
...
function initQuotesPage() {
  ...
  applyQuotesFilters('All Status');

  const searchInput = document.querySelector('[data-quotes-search-input]');
  const clearBtn = document.querySelector('[data-quotes-search-clear]');

  if (searchInput) {
    searchInput.addEventListener('input', function () {
      applyQuotesFilters(getCurrentQuotesStatusValue());
    });
  }
...
initQuotesPage();
`;function S({onOpenMainPage:e,onOpenMeasurePage:t,onOpenQuotesPage:n,onOpenOrdersPage:r,onOpenClientsPage:i,onOpenResourcesPage:a,onOpenAdminPage:o}){return(0,l.useEffect)(()=>{let s=document.createElement(`script`);s.type=`text/javascript`,s.dataset.wincoQuotesPage=`true`,s.text=ee,document.body.appendChild(s);let c=(()=>{let s=document.querySelector(`.quotes-page`);if(!s)return()=>{};let c=s.querySelectorAll(`.topbar-left .nav-item`),l=[];return c.forEach(s=>{let c=s.textContent.trim(),u=null;if(c===`Charles / Winco`&&(u=e),c===`Measure`&&(u=t),c===`Quotes`&&(u=n),c===`Orders`&&(u=r),c===`Clients`&&(u=i),c===`Resources`&&(u=a),c===`Admin`&&(u=o),u){let e=()=>u();s.style.cursor=`pointer`,s.addEventListener(`click`,e),l.push([s,e])}}),()=>{l.forEach(([e,t])=>e.removeEventListener(`click`,t))}})();return()=>{typeof c==`function`&&c(),s.parentNode&&s.parentNode.removeChild(s)}},[]),(0,p.jsx)(`div`,{className:`quotes-page`,dangerouslySetInnerHTML:{__html:x}})}var C=`<div class="app-preview">
    <div class="ipad-stage">
      <div class="app-frame">
        <nav class="topbar">
          <div class="topbar-inner">
            <div class="topbar-left">
              ...
              <div class="nav-item">Measure</div>
              <div class="nav-item">Quotes</div>
              <div class="nav-item current">Orders</div>
              <div class="nav-item">Clients</div>
              <div class="nav-item">Resources</div>
              <div class="nav-item">Admin</div>
            </div>
              ...
              <div class="orders-header">
                ...
                <div class="orders-header-tools">
                  ...
                  <div class="orders-search">
                    <input type="text" placeholder="Search" data-orders-search-input />
                    <button type="button" class="orders-search-clear hidden" data-orders-search-clear aria-label="Clear search">×</button>
                  </div>
                </div>
              </div>
              ...
              <div class="orders-table">
                <div class="orders-table-head">
                  <div class="orders-cell">
                    <span class="orders-sort-button">Order # <span class="orders-sort-arrow">▾</span></span>
                  </div>
                  <div class="orders-cell">
                    <div class="orders-head-filter active" onclick="toggleOrdersAccountFilter(event)">
                      <span data-account-filter-label>Account</span>
                      <span class="orders-sort-arrow">▾</span>
                      <div class="orders-filter-menu">
                        <div class="orders-filter-option current" onclick="selectOrdersAccountFilter(event, 'All Account')">All Account</div>
                        <div class="orders-filter-option" onclick="selectOrdersAccountFilter(event, 'Winco')">Winco</div>
                        <div class="orders-filter-option" onclick="selectOrdersAccountFilter(event, 'Dealer A')">Dealer A</div>
                        <div class="orders-filter-option" onclick="selectOrdersAccountFilter(event, 'Dealer B')">Dealer B</div>
                        <div class="orders-filter-option" onclick="selectOrdersAccountFilter(event, 'Dealer C')">Dealer C</div>
                      </div>
                    </div>
                  </div>
                  <div class="orders-cell">Client</div>
                  <div class="orders-cell">Project / Tag</div>
                  <div class="orders-cell">Product</div>
                  <div class="orders-cell">Qty</div>
                  <div class="orders-cell">Total Price</div>
                  <div class="orders-cell">
                    <div class="orders-head-filter active" onclick="toggleOrdersFilter(event)">
                      <span data-status-filter-label>Status</span>
                      <span class="orders-sort-arrow">▾</span>
                      <div class="orders-filter-menu">
                        <div class="orders-filter-option current" onclick="selectOrdersFilter(event, 'All Status')">All Status</div>
                        <div class="orders-filter-option" onclick="selectOrdersFilter(event, 'Ordered')">Ordered</div>
                        <div class="orders-filter-option" onclick="selectOrdersFilter(event, 'Completed')">Completed</div>
                      </div>
                    </div>
                  </div>
                  <div class="orders-cell orders-note-head">Note / PO #</div>
                </div>

                <div class="orders-row is-new" data-status="ordered" data-account="winco" data-search="OR260412-01 Winco Charles Living Room Dual 1234 99 Ave NW Edmonton install ordered partial shipment">
                  <div class="orders-cell"><span class="orders-order-id"><span class="orders-new-badge">NEW</span><span class="orders-order-text">OR260412-01</span></span></div>
                  <div class="orders-cell">Winco</div>
                  <div class="orders-cell">Charles</div>
                  <div class="orders-cell">Living Room</div>
                  <div class="orders-cell">Dual</div>
                  <div class="orders-cell">4</div>
                  <div class="orders-cell total">$1,876.37</div>
                  <div class="orders-cell status"><span class="orders-status-field"><select class="orders-status-select status-ordered" data-order-row-status><option value="ordered" selected>Ordered</option><option value="completed">Completed</option></select></span></div>
                  <div class="orders-cell orders-note-cell"><input class="orders-note-field" type="text" value="PO# 2418" placeholder="Note / PO #" /></div>
                </div>

                <div class="orders-row" data-status="completed" data-account="dealer a" data-search="OR260411-03 Dealer A Mina Kim Kitchen Dining Roller Calgary condo completed install">
                  <div class="orders-cell"><span class="orders-order-id">OR260411-03</span></div>
                  <div class="orders-cell">Dealer A</div>
                  <div class="orders-cell">Mina Kim</div>
                  <div class="orders-cell">Kitchen / Dining</div>
                  <div class="orders-cell">Roller</div>
                  <div class="orders-cell">3</div>
                  <div class="orders-cell total">$1,240.00</div>
                  <div class="orders-cell status"><span class="orders-status-field"><select class="orders-status-select status-completed" data-order-row-status><option value="ordered">Ordered</option><option value="completed" selected>Completed</option></select></span></div>
                  <div class="orders-cell orders-note-cell"><input class="orders-note-field" type="text" value="" placeholder="Note / PO #" /></div>
                </div>

                <div class="orders-row" data-status="ordered" data-account="dealer b" data-search="OR260410-02 Dealer B Dealer A Showhome Main Dual Sherwood Park builder ordered rush order">
                  <div class="orders-cell"><span class="orders-order-id">OR260410-02</span></div>
                  <div class="orders-cell">Dealer B</div>
                  <div class="orders-cell">Dealer A</div>
                  <div class="orders-cell">Showhome - Main</div>
                  <div class="orders-cell">Dual</div>
                  <div class="orders-cell">8</div>
                  <div class="orders-cell total">$3,820.50</div>
                  <div class="orders-cell status"><span class="orders-status-field"><select class="orders-status-select status-ordered" data-order-row-status><option value="ordered" selected>Ordered</option><option value="completed">Completed</option></select></span></div>
                  <div class="orders-cell orders-note-cell"><input class="orders-note-field" type="text" value="PO# 3187" placeholder="Note / PO #" /></div>
                </div>
              </div>
            </div>
          </section>
  ...
  </div>`,te=`function toggleOrdersFilter(event) {
      event.stopPropagation();
      const filter = event.currentTarget;
    ...
    function closeOrdersFilters() {
      document.querySelectorAll('.orders-head-filter.open').forEach(function (filter) {
        filter.classList.remove('open');
      });
    }

    function updateOrdersSearchClear() {
      const input = document.querySelector('[data-orders-search-input]');
      const clearBtn = document.querySelector('[data-orders-search-clear]');
      if (!input || !clearBtn) return;
      const hasValue = input.value.trim() !== '';
      clearBtn.classList.toggle('hidden', !hasValue);
    }

    function getOrdersSearchValue() {
      const input = document.querySelector('[data-orders-search-input]');
      return input ? input.value.trim().toLowerCase() : '';
    }

    function getCurrentOrdersStatusValue() {
      const label = document.querySelector('[data-status-filter-label]');
      const value = label ? label.textContent.trim() : 'Status';
      return value === 'Status' ? 'All Status' : value;
    }

    function getCurrentOrdersAccountValue() {
      const current = document.querySelector('.orders-head-filter [data-account-filter-label]')
        ? document.querySelector('.orders-head-filter [data-account-filter-label]').textContent.trim()
        : 'Account';
      return current === 'Account' ? 'All Account' : current;
    }

    function applyOrdersFilters(statusValue, accountValue) {
      const normalizedStatus = String(statusValue || 'All Status').toLowerCase();
      const normalizedAccount = String(accountValue || 'All Account').toLowerCase();
      const searchValue = getOrdersSearchValue();

      document.querySelectorAll('.orders-row').forEach(function (row) {
        const rowStatus = String(row.dataset.status || '').toLowerCase();
        const rowAccount = String(row.dataset.account || '').toLowerCase();
        const rowSearch = String(row.dataset.search || '').toLowerCase();

        const statusMatch = normalizedStatus === 'all status' || rowStatus === normalizedStatus;
        const accountMatch = normalizedAccount === 'all account' || rowAccount === normalizedAccount;
        const searchMatch = searchValue === '' || rowSearch.includes(searchValue);
        const shouldShow = statusMatch && accountMatch && searchMatch;

        row.style.display = shouldShow ? 'grid' : 'none';
      });

      updateOrdersSearchClear();
    }

    function syncOrderRowStatuses() {
      document.querySelectorAll('.orders-row').forEach(function (row) {
        const select = row.querySelector('[data-order-row-status]');
        if (!select) return;
        const value = String(select.value || 'ordered').toLowerCase();
        row.dataset.status = value;
        select.classList.remove('status-ordered', 'status-completed');
        select.classList.add(value === 'completed' ? 'status-completed' : 'status-ordered');
      });
    }

    function selectOrdersFilter(event, value) {
      event.stopPropagation();
      const option = event.currentTarget;
      const filter = option.closest('.orders-head-filter');
      if (!filter) return;

      filter.querySelectorAll('.orders-filter-option').forEach(function (item) {
        item.classList.remove('current');
      });
      option.classList.add('current');
      ...
      applyOrdersFilters(value, getCurrentOrdersAccountValue());
      closeOrdersFilters();
    }

    function selectOrdersAccountFilter(event, value) {
      event.stopPropagation();
      const option = event.currentTarget;
      const filter = option.closest('.orders-head-filter');
      if (!filter) return;
      ...
      const label = filter.querySelector('[data-account-filter-label]');
      if (label) {
        label.textContent = value === 'All Account' ? 'Account' : value;
      }

      applyOrdersFilters(getCurrentOrdersStatusValue(), value);
      closeOrdersFilters();
    }

    function toggleOrdersAccountFilter(event) {
      event.stopPropagation();
      const filter = event.currentTarget;
      const isOpen = filter.classList.contains('open');
      closeOrdersFilters();
    ...
    window.initOrdersPage = function initOrdersPage() {
      console.assert(document.querySelector('.orders-head-filter'), 'Status filter should exist.');
      console.assert(document.querySelectorAll('.orders-row').length >= 3, 'Orders list should have sample rows.');
      console.assert(document.querySelector('.orders-sort-button'), 'An order sort indicator should exist.');
      syncOrderRowStatuses();
      applyOrdersFilters('All Status', 'All Account');

      document.querySelectorAll('[data-order-row-status]').forEach(function (select) {
        select.addEventListener('change', function () {
          syncOrderRowStatuses();
          applyOrdersFilters(getCurrentOrdersStatusValue(), getCurrentOrdersAccountValue());
        });
      });
...
};`;function ne({onOpenMainPage:e,onOpenMeasurePage:t,onOpenQuotesPage:n,onOpenOrdersPage:r,onOpenClientsPage:i,onOpenResourcesPage:a,onOpenAdminPage:o}){return(0,l.useEffect)(()=>{let s=document.createElement(`script`);s.type=`text/javascript`,s.dataset.wincoOrdersPageV2=`true`,s.text=te,document.body.appendChild(s);let c=(()=>{let s=document.querySelector(`.orders-page`);if(!s)return()=>{};let c=s.querySelectorAll(`.topbar-left .nav-item`),l=[];return c.forEach(s=>{let c=s.textContent.trim(),u=null;if(c===`Charles / Winco`&&(u=e),c===`Measure`&&(u=t),c===`Quotes`&&(u=n),c===`Orders`&&(u=r),c===`Clients`&&(u=i),c===`Resources`&&(u=a),c===`Admin`&&(u=o),u){let e=()=>u();s.style.cursor=`pointer`,s.addEventListener(`click`,e),l.push([s,e])}}),()=>{l.forEach(([e,t])=>e.removeEventListener(`click`,t))}})(),l=window.setTimeout(()=>{typeof window.initOrdersPage==`function`&&window.initOrdersPage()},0);return()=>{typeof c==`function`&&c(),window.clearTimeout(l),s.parentNode&&s.parentNode.removeChild(s),window.initOrdersPage&&delete window.initOrdersPage}},[]),(0,p.jsx)(`div`,{className:`orders-page`,dangerouslySetInnerHTML:{__html:C}})}var re=`<div class="app-preview">
    <div class="ipad-stage">
      <div class="app-frame">
        <nav class="topbar">
          <div class="topbar-inner">
            <div class="topbar-left">
              ...
              <div class="nav-item">Quotes</div>
              <div class="nav-item">Orders</div>
              <div class="nav-item current">Clients</div>
              <div class="nav-item">Resources</div>
              <div class="nav-item">Admin</div>
            </div>
          </div>
        ...
        <main class="page-shell">
          <section class="page-blank">
            <div class="quotes-shell">
              <div class="quotes-header">
                <div class="quotes-title">Clients</div>
                <div class="quotes-header-tools">
                  <div class="quotes-search">
                    <input type="text" placeholder="Search" data-quotes-search-input />
                    <button type="button" class="quotes-search-clear hidden" data-quotes-search-clear aria-label="Clear search">×</button>
              ...
              <div class="quotes-table">
                <div class="quotes-table-head">
                  <div class="quotes-cell filter-cell">
                    <div class="quotes-account-head active" onclick="toggleAccountFilter(event)">
                      <span data-account-filter-label>Account</span>
                      <span class="quotes-sort-arrow">▾</span>
                      <div class="quotes-account-menu">
                        <div class="quotes-account-option current" onclick="selectAccountFilter(event, 'All')">All</div>
                        <div class="quotes-account-option" onclick="selectAccountFilter(event, 'Winco')">Winco</div>
                        <div class="quotes-account-option" onclick="selectAccountFilter(event, 'Winco Sales')">Winco Sales</div>
                        <div class="quotes-account-option" onclick="selectAccountFilter(event, 'Dealer A')">Dealer A</div>
                        <div class="quotes-account-option" onclick="selectAccountFilter(event, 'Dealer B')">Dealer B</div>
                        <div class="quotes-account-option" onclick="selectAccountFilter(event, 'Dealer C')">Dealer C</div>
                      </div>
                    </div>
                  </div>
                  <div class="quotes-cell">Client</div>
                  <div class="quotes-cell">Company</div>
                  <div class="quotes-cell">Phone</div>
                  <div class="quotes-cell filter-cell">
                    <div class="quotes-activity-head active" onclick="toggleActivityFilter(event)">
                      <span data-activity-filter-label>Activity</span>
                      <span class="quotes-sort-arrow">▾</span>
                      <div class="quotes-activity-menu">
                        <div class="quotes-activity-option current" onclick="selectActivityFilter(event, 'All')">All</div>
                        <div class="quotes-activity-option" onclick="selectActivityFilter(event, 'Ordered')">Ordered</div>
                        <div class="quotes-activity-option" onclick="selectActivityFilter(event, 'Estimate')">Estimate</div>
                      </div>
                    </div>
                  </div>
                  <div class="quotes-cell">
                ...
                <div class="quotes-row" data-search="Charles / Winco Charles Kim Winco Residential 780-555-0101 Ordered 04/12/2026" data-activity="ordered" data-account="winco">
                  <div class="quotes-cell">Charles / Winco</div>
                  <div class="quotes-cell">Charles Kim</div>
                  <div class="quotes-cell">Winco Residential</div>
                  <div class="quotes-cell">780-555-0101</div>
                  <div class="quotes-cell activity">Ordered</div>
                  <div class="quotes-cell muted">04/12/2026</div>
                </div>
                <div class="quotes-detail-row">
                  <div class="quotes-detail-layout">
                    <div class="quotes-detail-card client-info-card">
                      <div class="quotes-detail-card-head">
                        <div class="quotes-detail-card-title">Client Information</div>
                        <div class="quotes-detail-card-action" data-client-edit-toggle>Edit</div>
                      </div>
                      <div class="quotes-detail-card-body">
                        <div class="client-info-layout">
                          <div class="client-info-section">
                            <div class="client-info-section-title">Basic</div>
                            <div class="client-info-basic-grid">
                              <div class="client-info-basic-item">
                                <div class="client-info-basic-label">Account</div>
                                <div class="client-info-basic-value">Charles / Winco</div>
                                <input class="client-info-edit-input" type="text" value="Charles / Winco" />
                              </div>
                              <div class="client-info-basic-item">
                                <div class="client-info-basic-label">Client</div>
                                <div class="client-info-basic-value">Charles Kim</div>
                                <input class="client-info-edit-input" type="text" value="Charles Kim" />
                              </div>
                              <div class="client-info-basic-item">
                                <div class="client-info-basic-label">Company</div>
                                <div class="client-info-basic-value">Winco Residential</div>
                                <input class="client-info-edit-input" type="text" value="Winco Residential" />
                              </div>
                            </div>
                          </div>

                          <div class="client-info-section">
                            <div class="client-info-section-head">
                              <div class="client-info-section-title">Phones</div>
                              <div class="client-info-add" data-add-target="phones">+ Add</div>
                            </div>
                            <div class="client-info-inline-grid">
                              <div class="client-info-list-item"><span class="display-value">780-555-0101</span><input class="client-info-edit-input" type="text" value="780-555-0101" /></div>
                              <div class="client-info-list-item"><span class="display-value">780-555-0188</span><input class="client-info-edit-input" type="text" value="780-555-0188" /></div>
                            </div>
                          </div>

                          <div class="client-info-section">
                            <div class="client-info-section-head">
                              <div class="client-info-section-title">Emails</div>
                              <div class="client-info-add" data-add-target="emails">+ Add</div>
                            </div>
                            <div class="client-info-list">
                              <div class="client-info-list-item"><span class="display-value">charles@example.com</span><input class="client-info-edit-input" type="text" value="charles@example.com" /></div>
                              <div class="client-info-list-item"><span class="display-value">charles.project@example.com</span><input class="client-info-edit-input" type="text" value="charles.project@example.com" /></div>
                            </div>
                          </div>

                          <div class="client-info-section">
                            <div class="client-info-section-head">
                              <div class="client-info-section-title">Addresses</div>
                              <div class="client-info-add" data-add-target="addresses">+ Add</div>
                            </div>
                            <div class="client-info-list">
                              <div class="client-info-list-item"><span class="display-value">1234 99 Ave NW, Edmonton, AB</span><input class="client-info-edit-input" type="text" value="1234 99 Ave NW, Edmonton, AB" /></div>
                              <div class="client-info-list-item"><span class="display-value">554 Riverbend Gate SW, Calgary, AB</span><input class="client-info-edit-input" type="text" value="554 Riverbend Gate SW, Calgary, AB" /></div>
                            </div>
                          </div>

                          <div class="client-info-section">
                            <div class="client-info-section-title">Note</div>
                            <div class="client-info-note-box"><div class="display-value">Main customer profile with multiple projects and contact records.</div><textarea class="client-info-edit-textarea">Main customer profile with multiple projects and contact records.</textarea></div>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="quotes-detail-card">
                      <div class="quotes-detail-card-head">
                        <div class="quotes-detail-card-title">History</div>
                      </div>
                      <div class="quotes-detail-card-body">
                        <div class="history-list">
                          <div class="history-row" data-history-type="estimate" data-history-no="Q260412-01">
                            <div class="history-cell type">Estimate</div>
                            <div class="history-cell">Q260412-01</div>
                            <div class="history-cell project">
                              <div class="history-project-main">Main House</div>
                              <div class="history-project-sub">Living Room</div>
                            </div>
                            <div class="history-cell">04/12/2026</div>
                            <div class="history-cell total">$1,876</div>
                            <div class="history-cell chevron">›</div>
                          </div>
                          <div class="history-row" data-history-type="order" data-history-no="OR260410-02">
                            <div class="history-cell type">Order</div>
                            <div class="history-cell">OR260410-02</div>
                            <div class="history-cell project">
                              <div class="history-project-main">Rental House</div>
                              <div class="history-project-sub">Kitchen</div>
                            </div>
                            <div class="history-cell">04/14/2026</div>
                            <div class="history-cell total">$2,980</div>
                            <div class="history-cell chevron">›</div>
                          </div>
                          <div class="history-row" data-history-type="estimate" data-history-no="Q260403-05">
                            <div class="history-cell type">Estimate</div>
                            <div class="history-cell">Q260403-05</div>
                            <div class="history-cell project">
                              <div class="history-project-main">Basement Reno</div>
                              <div class="history-project-sub">Main Floor</div>
                            </div>
                            <div class="history-cell">04/09/2026</div>
                            <div class="history-cell total">$940</div>
                            <div class="history-cell chevron">›</div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="quotes-row" data-search="North Branch Mina Kim MK Interior 403-555-0118 Estimate 04/11/2026" data-activity="estimate" data-account="dealer b">
                  <div class="quotes-cell">North Branch</div>
                  <div class="quotes-cell">Mina Kim</div>
                  <div class="quotes-cell">MK Interior</div>
                  <div class="quotes-cell">403-555-0118</div>
                  <div class="quotes-cell activity">Estimate</div>
                  <div class="quotes-cell muted">04/11/2026</div>
                </div>
                <div class="quotes-detail-row">
                  <div class="quotes-detail-layout">
                ...
                <div class="quotes-row" data-search="Dealer A James Lee Lee Construction 587-555-0199 Ordered 04/10/2026" data-activity="ordered" data-account="dealer a">
                  <div class="quotes-cell">Dealer A</div>
                  <div class="quotes-cell">James Lee</div>
                  <div class="quotes-cell">Lee Construction</div>
                  <div class="quotes-cell">587-555-0199</div>
                  <div class="quotes-cell activity">Ordered</div>
                  <div class="quotes-cell muted">04/10/2026</div>
                </div>
                <div class="quotes-detail-row">
  ...
  </div>`,w=`function updateQuotesSearchClear() {
      const input = document.querySelector('[data-quotes-search-input]');
      const clearBtn = document.querySelector('[data-quotes-search-clear]');
      if (!input || !clearBtn) return;
      const hasValue = input.value.trim() !== '';
    ...
    function getCurrentAccountValue() {
      const current = document.querySelector('.quotes-account-option.current');
      return current ? current.textContent.trim().toLowerCase() : 'all';
    }

    function toggleAccountFilter(event) {
      event.stopPropagation();
      const filter = event.currentTarget;
      filter.classList.toggle('open');
    }
    ...
    function closeAccountFilter() {
      document.querySelectorAll('.quotes-account-head.open').forEach(function (filter) {
        filter.classList.remove('open');
      });
    }

    function selectAccountFilter(event, value) {
      event.stopPropagation();
      const option = event.currentTarget;
      const filter = option.closest('.quotes-account-head');
      if (!filter) return;

      filter.querySelectorAll('.quotes-account-option').forEach(function (item) {
        item.classList.remove('current');
      });
      option.classList.add('current');
      ...
      const label = filter.querySelector('[data-account-filter-label]');
      if (label) {
        label.textContent = value === 'All' ? 'Account' : value;
      }

      applyQuotesSearchOnly();
      closeAccountFilter();
    }

    function getCurrentActivityValue() {
      const current = document.querySelector('.quotes-activity-option.current');
      return current ? current.textContent.trim().toLowerCase() : 'all';
    }
    ...
    function closeActivityFilter() {
      document.querySelectorAll('.quotes-activity-head.open').forEach(function (filter) {
        filter.classList.remove('open');
      });
    }

    function selectActivityFilter(event, value) {
      event.stopPropagation();
      const option = event.currentTarget;
      const filter = option.closest('.quotes-activity-head');
      if (!filter) return;

      filter.querySelectorAll('.quotes-activity-option').forEach(function (item) {
        item.classList.remove('current');
      });
      option.classList.add('current');

      const label = filter.querySelector('[data-activity-filter-label]');
      if (label) {
        label.textContent = value === 'All' ? 'Activity' : value;
      }
    ...
    function applyQuotesSearchOnly() {
      const searchValue = getQuotesSearchValue();
      const accountValue = getCurrentAccountValue();
      const activityValue = getCurrentActivityValue();

      document.querySelectorAll('.quotes-row').forEach(function (row) {
        const rowSearch = String(row.dataset.search || '').toLowerCase();
        const rowActivity = String(row.dataset.activity || '').toLowerCase();
        const rowAccount = String(row.dataset.account || '').toLowerCase();
        const searchMatch = searchValue === '' || rowSearch.includes(searchValue);
        const activityMatch = activityValue === 'all' || rowActivity === activityValue;
        const accountMatch = accountValue === 'all' || rowAccount === accountValue;
        const shouldShow = searchMatch && activityMatch && accountMatch;
        row.style.display = shouldShow ? 'grid' : 'none';

        const detail = row.nextElementSibling;
        if (detail && detail.classList.contains('quotes-detail-row')) {
          detail.style.display = shouldShow && detail.classList.contains('open') ? 'block' : 'none';
        }
      });
    ...
    function closeAllDetails() {
      document.querySelectorAll('.quotes-row.expanded').forEach(function (row) {
        row.classList.remove('expanded');
      });

      document.querySelectorAll('.quotes-detail-row.open').forEach(function (detail) {
    ...
    function toggleDetailRow(row) {
      const detail = row.nextElementSibling;
      if (!detail || !detail.classList.contains('quotes-detail-row')) return;
    ...
    function openHistoryItem(historyRow) {
      const type = String(historyRow.dataset.historyType || '').toLowerCase();
      const number = String(historyRow.dataset.historyNo || '').trim();
      const destination = type === 'order' ? 'Orders detail' : 'Quotes / Measure detail';
      window.alert('Open ' + destination + ' for ' + number);
    }

    function syncClientInfoCard(card) {
      card.querySelectorAll('.client-info-basic-item').forEach(function (item) {
        const display = item.querySelector('.client-info-basic-value');
        const input = item.querySelector('.client-info-edit-input');
        if (display && input) {
          display.textContent = input.value;
        }
      });

      card.querySelectorAll('.client-info-list-item').forEach(function (item) {
        const display = item.querySelector('.display-value');
        const input = item.querySelector('.client-info-edit-input');
      ...
      card.querySelectorAll('.client-info-note-box').forEach(function (item) {
        const display = item.querySelector('.display-value');
        const textarea = item.querySelector('.client-info-edit-textarea');
        if (display && textarea) {
    ...
    function toggleClientInfoEdit(card, button) {
      const isEditing = card.classList.contains('editing');
      if (isEditing) {
        syncClientInfoCard(card);
    ...
    function createClientInfoListItem(value, target) {
      const item = document.createElement('div');
      item.className = 'client-info-list-item';
      ...
      input.className = 'client-info-edit-input';
      input.type = 'text';
      input.value = value || '';
    ...
    function addClientInfoItem(button) {
      const target = String(button.dataset.addTarget || '').toLowerCase();
      const section = button.closest('.client-info-section');
      if (!section) return;

      let container = null;
      if (target === 'phones') {
        container = section.querySelector('.client-info-inline-grid');
      } else if (target === 'emails' || target === 'addresses') {
        container = section.querySelector('.client-info-list');
      }
      if (!container) return;

      const item = createClientInfoListItem('', target);
    ...
    window.initClientsPage = function initClientsPage() {
      ...
      document.querySelectorAll('.history-row').forEach(function (historyRow) {
        historyRow.addEventListener('click', function (event) {
          event.stopPropagation();
          openHistoryItem(historyRow);
        });
      });

      document.querySelectorAll('[data-client-edit-toggle]').forEach(function (button) {
        button.addEventListener('click', function (event) {
          event.stopPropagation();
          const card = button.closest('.client-info-card');
          if (!card) return;
          toggleClientInfoEdit(card, button);
        });
      });

      document.querySelectorAll('.client-info-add').forEach(function (button) {
        button.addEventListener('click', function (event) {
          event.stopPropagation();
          addClientInfoItem(button);
        });
      });
};`;function ie({onOpenMainPage:e,onOpenMeasurePage:t,onOpenQuotesPage:n,onOpenOrdersPage:r,onOpenClientsPage:i,onOpenResourcesPage:a,onOpenAdminPage:o}){return(0,l.useEffect)(()=>{let s=document.createElement(`script`);s.type=`text/javascript`,s.dataset.wincoClientsPage=`true`,s.text=w,document.body.appendChild(s);let c=(()=>{let s=document.querySelector(`.clients-page`);if(!s)return()=>{};let c=s.querySelectorAll(`.topbar-left .nav-item`),l=[];return c.forEach(s=>{let c=s.textContent.trim(),u=null;if(c===`Charles / Winco`&&(u=e),c===`Measure`&&(u=t),c===`Quotes`&&(u=n),c===`Orders`&&(u=r),c===`Clients`&&(u=i),c===`Resources`&&(u=a),c===`Admin`&&(u=o),u){let e=()=>u();s.style.cursor=`pointer`,s.addEventListener(`click`,e),l.push([s,e])}}),()=>{l.forEach(([e,t])=>e.removeEventListener(`click`,t))}})(),l=window.setTimeout(()=>{typeof window.initClientsPage==`function`&&window.initClientsPage()},0);return()=>{typeof c==`function`&&c(),window.clearTimeout(l),s.parentNode&&s.parentNode.removeChild(s),window.initClientsPage&&delete window.initClientsPage}},[]),(0,p.jsx)(`div`,{className:`clients-page`,dangerouslySetInnerHTML:{__html:re}})}var ae=`<div class="app-preview">
    <div class="ipad-stage">
      <div class="app-frame">
        <nav class="topbar">
          <div class="topbar-inner">
            <div class="topbar-left">
              ...
              <div class="nav-item">Orders</div>
              <div class="nav-item">Clients</div>
              <div class="nav-item current">Resources</div>
              <div class="nav-item">Admin</div>
            </div>
            <div class="topbar-actions"></div>
          </div>
            ...
            <div class="orders-shell">
              <div class="orders-header">
                <div class="orders-header-left">
                  <div class="orders-title">Resources</div>
                  <div class="resource-view-tabs">
                    <button class="resource-view-tab is-active" type="button" data-resource-tab="documents">Documents</button>
                    <button class="resource-view-tab" type="button" data-resource-tab="images">Image Library</button>
                  </div>
                </div>
                <div class="orders-header-tools">
                  <button class="admin-action-btn documents-upload-btn" type="button">Upload</button>
                  <button class="admin-action-btn" type="button" data-manage-toggle>Manage</button>
                  <button class="admin-action-btn manage-save-btn" type="button" data-manage-save>Save</button>
                  <div class="manage-save-status" data-manage-save-status>Changes saved</div>
                  <button class="admin-action-btn manage-delete-btn" type="button">Delete</button>
                </div>
              </div>

              <div class="resource-content-pane is-active" data-resource-pane="documents">
                <div class="orders-table">
                <div class="orders-table-head">
                  <div class="orders-cell manage-select-head"><input class="manage-checkbox" type="checkbox" aria-label="Select all" /></div>
                  <div class="orders-cell">
                    <span class="orders-sort-button">Document Title</span>
                  </div>
                  <div class="orders-cell">File</div>
                  <div class="orders-cell">Rev.</div>
                  <div class="orders-cell">Updated</div>
                  <div class="orders-cell manage-access-head">Access</div>
                  <div class="orders-cell resource-download-head">↓</div>
                </div>

                <div class="orders-row is-new" draggable="false">
                  <div class="orders-cell manage-select-cell"><input class="manage-checkbox" type="checkbox" aria-label="Select Roller Measuring Guide" /></div>
                  <div class="orders-cell"><span class="orders-order-id"><span class="orders-new-badge">NEW</span><span class="orders-order-text">Roller Measuring Guide</span></span></div>
                  <div class="orders-cell">PDF</div>
                  <div class="orders-cell">Rev. 04/2026</div>
                  <div class="orders-cell">2026-04-18</div>
                  <div class="orders-cell manage-access-cell">
                    <select class="manage-access-select" aria-label="Access for Roller Measuring Guide">
                      <option selected>Public</option>
                      <option>Dealer</option>
                      <option>Winco Only</option>
                    </select>
                  </div>
                  <div class="orders-cell resource-download-cell"><button class="resource-download-btn" type="button" aria-label="Download">↓</button></div>
                </div>

                <div class="orders-row" draggable="false">
                  <div class="orders-cell manage-select-cell"><input class="manage-checkbox" type="checkbox" aria-label="Select Product Warranty" /></div>
                  <div class="orders-cell"><span class="orders-order-id">Product Warranty</span></div>
                  <div class="orders-cell">PDF</div>
                  <div class="orders-cell">Rev. 04/2026</div>
                  <div class="orders-cell">2026-04-12</div>
                  <div class="orders-cell manage-access-cell">
                    <select class="manage-access-select" aria-label="Access for Product Warranty">
                ...
                <div class="orders-row" draggable="false">
                  <div class="orders-cell manage-select-cell"><input class="manage-checkbox" type="checkbox" aria-label="Select Order Submission Form" /></div>
                  <div class="orders-cell"><span class="orders-order-id">Order Submission Form</span></div>
                  <div class="orders-cell">Excel</div>
                  <div class="orders-cell">-</div>
                  <div class="orders-cell">2026-04-08</div>
                  <div class="orders-cell manage-access-cell">
                    <select class="manage-access-select" aria-label="Access for Order Submission Form">
                      <option>Public</option>
                      <option selected>Dealer</option>
                      <option>Winco Only</option>
                    </select>
              ...
              <section class="image-library-section resource-content-pane" data-resource-pane="images">
              <div class="image-library-header">
                <div class="folder-selection-count" data-folder-selection-count>0 selected</div>
                <button class="admin-action-btn manage-image-folder-btn" type="button">New Folder</button>
              </div>

              <div class="image-library-grid image-folder-list-mode" data-image-folder-list>
                <div class="image-folder-card" data-folder-open="Product Photos">
                  <div class="image-folder-thumb">
                  <div class="image-folder-mini"></div>
                  <div class="image-folder-mini"></div>
                  <div class="image-folder-mini"></div>
                  <div class="image-folder-mini"></div>
                  <div class="image-folder-mini"></div>
                  ...
                  <div class="image-folder-meta">
                    <div class="image-folder-name">Product Photos</div>
                    <div class="image-folder-info">18 images</div>
                  </div>
                </div>

                <div class="image-folder-card" data-folder-open="Fabric Samples">
                  <div class="image-folder-thumb">
                  <div class="image-folder-mini"></div>
                  <div class="image-folder-mini"></div>
                  <div class="image-folder-mini"></div>
                  ...
                  <div class="image-folder-meta">
                    <div class="image-folder-name">Fabric Samples</div>
                    <div class="image-folder-info">26 images</div>
                  </div>
                </div>

                <div class="image-folder-card" data-folder-open="Hardware Samples">
                  <div class="image-folder-thumb">
                  <div class="image-folder-mini"></div>
                  <div class="image-folder-mini"></div>
                  <div class="image-folder-mini"></div>
                  ...
                  <div class="image-folder-meta">
                    <div class="image-folder-name">Hardware Samples</div>
                    <div class="image-folder-info">12 images</div>
                  </div>
                </div>

                <div class="image-folder-card" data-folder-open="Installation Examples">
                  <div class="image-folder-thumb">
                  <div class="image-folder-mini"></div>
                  <div class="image-folder-mini"></div>
                  <div class="image-folder-mini"></div>
                  ...
                  <div class="image-folder-meta">
                    <div class="image-folder-name">Installation Examples</div>
                    <div class="image-folder-info">9 images</div>
                  </div>
                </div>
              </div>

              <template id="image-folder-card-template">
                <div class="image-folder-card" data-folder-open="">
                  <div class="image-folder-thumb">
                    <div class="image-folder-mini"></div>
                    <div class="image-folder-mini"></div>
                    <div class="image-folder-mini"></div>
                  ...
                  <div class="image-folder-meta">
                    <div class="image-folder-name"></div>
                    <div class="image-folder-info">0 images</div>
                  </div>
                </div>
              </template>

              <div class="image-folder-detail" data-image-folder-detail>
                <div class="image-folder-detail-head">
                  <div class="image-folder-detail-left">
                    <button class="image-folder-back" type="button" data-folder-back>← Back</button>
                    <div class="image-folder-detail-title" data-folder-detail-title>Product Photos</div>
                  </div>
                  <div class="orders-header-tools">
                    <div class="image-selection-count" data-image-selection-count>0 selected</div>
                    <button class="admin-action-btn manage-image-rename-btn" type="button">Rename Folder</button>
                    <button class="admin-action-btn manage-image-upload-btn" type="button">Upload Images</button>
                  </div>
                </div>

                <div class="image-thumb-grid" data-image-thumb-grid>
                  <div class="image-tile" draggable="false">Image</div>
                  <div class="image-tile" draggable="false">Image</div>
                  <div class="image-tile" draggable="false">Image</div>
                  <div class="image-tile" draggable="false">Image</div>
                  <div class="image-tile" draggable="false">Image</div>
  ...
  <div class="upload-overlay" data-image-upload-overlay>
    <div class="upload-dialog" role="dialog" aria-modal="true" aria-labelledby="imageUploadTitle">
      <div class="upload-title" id="imageUploadTitle">Upload Images</div>
      <div class="upload-text">Add images to the current folder. On PC, drag files here or choose from your computer. On iPad, choose from Photos or Files.</div>
      <div class="upload-dropzone">
        <div class="upload-dropzone-title">Drag images here</div>
        <div class="upload-dropzone-sub">or choose files from device</div>
      </div>
      <div class="upload-actions">
        <button class="confirm-btn" type="button" data-image-upload-cancel>Cancel</button>
        <button class="confirm-btn delete" type="button" data-image-upload-choose>Choose Files</button>
      </div>
    </div>
  </div>

  <div class="upload-overlay" data-new-folder-overlay>
    <div class="upload-dialog" role="dialog" aria-modal="true" aria-labelledby="newFolderTitle">
      <div class="upload-title" id="newFolderTitle">New Folder</div>
      <div class="upload-text">Create a new image folder for organizing customer presentation photos and reference images.</div>
      <input class="folder-input" type="text" placeholder="Folder name" data-new-folder-input />
      <div class="upload-actions">
        <button class="confirm-btn" type="button" data-new-folder-cancel>Cancel</button>
        <button class="confirm-btn delete" type="button" data-new-folder-create>Create</button>
      </div>
    </div>
  </div>

  <div class="upload-overlay" data-rename-folder-overlay>
    <div class="upload-dialog" role="dialog" aria-modal="true" aria-labelledby="renameFolderTitle">
      <div class="upload-title" id="renameFolderTitle">Rename Folder</div>
      <div class="upload-text">Update the folder name for this image collection.</div>
      <input class="folder-input" type="text" placeholder="Folder name" data-rename-folder-input />
      <div class="upload-actions">
        <button class="confirm-btn" type="button" data-rename-folder-cancel>Cancel</button>
        <button class="confirm-btn delete" type="button" data-rename-folder-save>Save</button>
      </div>
    </div>
  </div>

  <div class="image-preview-overlay" data-image-preview-overlay>
    <div class="image-preview-dialog" role="dialog" aria-modal="true" aria-labelledby="imagePreviewTitle">
      <div class="image-preview-head">
        <div class="image-preview-title" id="imagePreviewTitle" data-image-preview-title>Image Preview</div>
        <div class="orders-header-tools" style="gap:8px;">
          <div class="image-preview-count" data-image-preview-count>1 / 6</div>
          <button class="image-preview-close" type="button" data-image-preview-close>×</button>
        </div>
      </div>
      <div class="image-preview-stage" data-image-preview-stage>
        <button class="image-preview-nav prev" type="button" data-image-preview-prev>‹</button>
        <div class="image-preview-frame">
          <div data-image-preview-content>Large Image Preview</div>
        </div>
        <button class="image-preview-nav next" type="button" data-image-preview-next>›</button>
      </div>
      <div class="image-preview-strip" data-image-preview-strip>
        <button class="image-preview-thumb is-active" type="button" data-image-preview-thumb="0">1</button>
        <button class="image-preview-thumb" type="button" data-image-preview-thumb="1">2</button>
        <button class="image-preview-thumb" type="button" data-image-preview-thumb="2">3</button>
        <button class="image-preview-thumb" type="button" data-image-preview-thumb="3">4</button>
        <button class="image-preview-thumb" type="button" data-image-preview-thumb="4">5</button>
        <button class="image-preview-thumb" type="button" data-image-preview-thumb="5">6</button>
      </div>
    </div>
  </div>

  <div class="confirm-overlay" data-delete-confirm>
    <div class="confirm-dialog" role="dialog" aria-modal="true" aria-labelledby="deleteConfirmTitle">
      <div class="confirm-title" id="deleteConfirmTitle" data-delete-confirm-title>Delete selected files?</div>
      <div class="confirm-text" data-delete-confirm-text>This action will remove the selected resource items from the current list.</div>
      <div class="confirm-actions">
        <button class="confirm-btn" type="button" data-delete-cancel>Cancel</button>
        <button class="confirm-btn delete" type="button" data-delete-confirm-btn>Delete</button>
      </div>
    </div>
  </div>`,oe=`function applyOrdersFilters() {
      document.querySelectorAll('.orders-row').forEach(function (row) {
        row.style.display = 'grid';
      });
    }

    window.initResourcesPage = function initResourcesPage() {
      const manageToggle = document.querySelector('[data-manage-toggle]');
      const manageDeleteBtn = document.querySelector('.manage-delete-btn');
      const manageSaveBtn = document.querySelector('[data-manage-save]');
      const manageSaveStatus = document.querySelector('[data-manage-save-status]');
      const ordersShell = document.querySelector('.orders-shell');
      const selectAllCheckbox = document.querySelector('.manage-select-head .manage-checkbox');
      const deleteConfirmOverlay = document.querySelector('[data-delete-confirm]');
      ...
      const deleteConfirmBtn = document.querySelector('[data-delete-confirm-btn]');

      const resourceTabs = Array.from(document.querySelectorAll('[data-resource-tab]'));
      const resourcePanes = Array.from(document.querySelectorAll('[data-resource-pane]'));
      const documentsUploadBtn = document.querySelector('.documents-upload-btn');

      const imageFolderCards = Array.from(document.querySelectorAll('.image-folder-card[data-folder-open]'));
      const imageFolderList = document.querySelector('[data-image-folder-list]');
      const imageFolderDetail = document.querySelector('[data-image-folder-detail]');
      const imageFolderDetailTitle = document.querySelector('[data-folder-detail-title]');
      const imageFolderBack = document.querySelector('[data-folder-back]');
      const imageThumbGrid = document.querySelector('[data-image-thumb-grid]');
      const imageFolderTemplate = document.querySelector('#image-folder-card-template');
      const imageSelectionCount = document.querySelector('[data-image-selection-count]');
      const folderSelectionCount = document.querySelector('[data-folder-selection-count]');

      const imageUploadOverlay = document.querySelector('[data-image-upload-overlay]');
      const imageUploadCancel = document.querySelector('[data-image-upload-cancel]');
      const imageUploadChoose = document.querySelector('[data-image-upload-choose]');
      const imageUploadBtn = document.querySelector('.manage-image-upload-btn');

      const newFolderBtn = document.querySelector('.manage-image-folder-btn');
      const newFolderOverlay = document.querySelector('[data-new-folder-overlay]');
      const newFolderCancel = document.querySelector('[data-new-folder-cancel]');
      const newFolderCreate = document.querySelector('[data-new-folder-create]');
      const newFolderInput = document.querySelector('[data-new-folder-input]');

      const renameFolderBtn = document.querySelector('.manage-image-rename-btn');
      const renameFolderOverlay = document.querySelector('[data-rename-folder-overlay]');
      const renameFolderCancel = document.querySelector('[data-rename-folder-cancel]');
      const renameFolderSave = document.querySelector('[data-rename-folder-save]');
      const renameFolderInput = document.querySelector('[data-rename-folder-input]');
      const imagePreviewOverlay = document.querySelector('[data-image-preview-overlay]');
      ...
      const imagePreviewContent = document.querySelector('[data-image-preview-content]');
      const imagePreviewCount = document.querySelector('[data-image-preview-count]');
      const imagePreviewPrev = document.querySelector('[data-image-preview-prev]');
      const imagePreviewNext = document.querySelector('[data-image-preview-next]');
      const imagePreviewStrip = document.querySelector('[data-image-preview-strip]');

      let currentFolderName = 'Product Photos';
      let saveStatusTimer = null;
      let hasManageChanges = false;
      let draggedImageTile = null;
      let draggedDocumentRow = null;
      let previewIndex = 0;
      let touchStartX = 0;

      function getRowCheckboxes() {
        return Array.from(document.querySelectorAll('.manage-select-cell .manage-checkbox'));
      }

      function getDocumentRows() {
        return Array.from(document.querySelectorAll('[data-resource-pane="documents"] .orders-row'));
      }
      ...
      function getSelectedFolderCards() {
        return Array.from(document.querySelectorAll('.image-folder-list-mode .image-folder-card.is-selected'));
      }

      function imagesPaneIsActive() {
        const pane = document.querySelector('[data-resource-pane="images"]');
        return !!(pane && pane.classList.contains('is-active'));
      }

      function imageDetailIsActive() {
        return !!(imageFolderDetail && imageFolderDetail.classList.contains('is-active'));
      }

      function folderListIsVisible() {
        return !!(imageFolderList && imageFolderList.style.display !== 'none');
      }

      function updateManageDeleteState() {
        if (!manageDeleteBtn) return;
        const hasCheckedRows = getRowCheckboxes().some(function (checkbox) {
          return checkbox.checked;
        });
        const hasSelectedImages = getImageTiles().some(function (tile) {
          return tile.classList.contains('is-selected');
        });
        const hasSelectedFolders = getSelectedFolderCards().length > 0;
        manageDeleteBtn.classList.toggle('is-enabled', hasCheckedRows || hasSelectedImages || hasSelectedFolders);
      }

      function updateManageSaveState() {
        if (!manageSaveBtn) return;
        manageSaveBtn.classList.toggle('is-enabled', hasManageChanges);
      }

      function markManageChanged() {
        hasManageChanges = true;
        updateManageSaveState();
      }

      function resetManageChanged() {
        hasManageChanges = false;
        updateManageSaveState();
      }
      ...
      function updateImageSelectionCount() {
        if (!imageSelectionCount) return;
        const selectedCount = getImageTiles().filter(function (tile) {
          return tile.classList.contains('is-selected');
        }).length;
        imageSelectionCount.textContent = selectedCount + ' selected';
        imageSelectionCount.classList.toggle('is-visible', selectedCount > 0);
      }

      function updateFolderSelectionCount() {
        if (!folderSelectionCount) return;
        const selectedCount = getSelectedFolderCards().length;
        folderSelectionCount.textContent = selectedCount + ' selected';
        folderSelectionCount.classList.toggle('is-visible', selectedCount > 0);
      }
      ...
      function clearImageSelections() {
        getImageTiles().forEach(function (tile) {
          tile.classList.remove('is-selected');
        });
        document.querySelectorAll('.image-folder-list-mode .image-folder-card.is-selected').forEach(function (card) {
      ...
      function showSaveStatus() {
        if (!manageSaveStatus) return;
        manageSaveStatus.classList.add('is-visible');
        window.clearTimeout(saveStatusTimer);
        saveStatusTimer = window.setTimeout(function () {
          manageSaveStatus.classList.remove('is-visible');
        }, 1400);
      }
      ...
      function closeDeleteConfirm() {
        ...
        if (deleteConfirmTitle) deleteConfirmTitle.textContent = 'Delete selected files?';
        if (deleteConfirmText) deleteConfirmText.textContent = 'This action will remove the selected resource items from the current list.';
      }

      function closeImageUpload() {
        if (imageUploadOverlay) imageUploadOverlay.classList.remove('is-open');
      }

      function closeNewFolder() {
        if (newFolderOverlay) newFolderOverlay.classList.remove('is-open');
        if (newFolderInput) newFolderInput.value = '';
      }

      function closeRenameFolder() {
        if (renameFolderOverlay) renameFolderOverlay.classList.remove('is-open');
        if (renameFolderInput) renameFolderInput.value = '';
      }

      function getPreviewTiles() {
        return getImageTiles();
      }

      function renderImagePreview() {
        const tiles = getPreviewTiles();
        if (!tiles.length) return;
        const safeIndex = Math.max(0, Math.min(previewIndex, tiles.length - 1));
        previewIndex = safeIndex;
        const labelText = tiles[safeIndex].textContent.trim() || 'Image Preview';
        if (imagePreviewTitle) imagePreviewTitle.textContent = labelText;
        if (imagePreviewContent) imagePreviewContent.textContent = labelText;
        if (imagePreviewCount) imagePreviewCount.textContent = (safeIndex + 1) + ' / ' + tiles.length;

        if (imagePreviewStrip) {
          imagePreviewStrip.innerHTML = '';
          tiles.forEach(function (_tile, index) {
            const thumb = document.createElement('button');
            thumb.type = 'button';
            thumb.className = 'image-preview-thumb' + (index === safeIndex ? ' is-active' : '');
            thumb.textContent = String(index + 1);
            thumb.setAttribute('data-image-preview-thumb', String(index));
            thumb.addEventListener('click', function () {
              openImagePreviewByIndex(index);
            });
      ...
      function openImagePreviewByIndex(index) {
        previewIndex = index;
        renderImagePreview();
        if (imagePreviewOverlay) imagePreviewOverlay.classList.add('is-open');
      }

      function moveImagePreview(step) {
        const tiles = getPreviewTiles();
        if (!tiles.length) return;
        previewIndex = Math.max(0, Math.min(previewIndex + step, tiles.length - 1));
        renderImagePreview();
      }

      function openImagePreview(labelText) {
        const tiles = getPreviewTiles();
        const matchIndex = tiles.findIndex(function (tile) {
          return (tile.textContent.trim() || 'Image Preview') === labelText;
        });
        openImagePreviewByIndex(matchIndex >= 0 ? matchIndex : 0);
      }
      ...
      function removeCheckedRows() {
        getRowCheckboxes().forEach(function (checkbox) {
          ...
          const row = checkbox.closest('.orders-row');
          if (row) row.remove();
        });
        clearAllSelections();
        syncSelectAllState();
      ...
      function removeSelectedImages() {
        getImageTiles().forEach(function (tile) {
          if (tile.classList.contains('is-selected')) tile.remove();
        });
        clearImageSelections();
        markManageChanged();
      }

      function removeSelectedEmptyFolders() {
        getSelectedFolderCards().forEach(function (card) {
          const infoEl = card.querySelector('.image-folder-info');
          const infoText = infoEl ? infoEl.textContent.trim().toLowerCase() : '';
          if (infoText.indexOf('0 images') === 0) {
            card.remove();
          }
        });
        clearImageSelections();
      ...
      function updateCurrentFolderInfoCount() {
        const targetCard = Array.from(document.querySelectorAll('.image-folder-card[data-folder-open]')).find(function (card) {
          return card.dataset.folderOpen === currentFolderName;
        });
        if (!targetCard) return;
        const infoEl = targetCard.querySelector('.image-folder-info');
        if (!infoEl) return;
        infoEl.textContent = getImageTiles().length + ' images';
      }

      function appendSampleImages(count) {
        if (!imageThumbGrid) return;
        for (let i = 0; i < count; i += 1) {
          const tile = document.createElement('div');
          tile.className = 'image-tile';
          tile.setAttribute('draggable', 'false');
          tile.textContent = 'Image';
          imageThumbGrid.appendChild(tile);
        }
        updateCurrentFolderInfoCount();
        markManageChanged();
      }

      function setActiveResourcePane(targetPane) {
        resourceTabs.forEach(function (tab) {
          tab.classList.toggle('is-active', tab.dataset.resourceTab === targetPane);
        });
        resourcePanes.forEach(function (pane) {
          pane.classList.toggle('is-active', pane.dataset.resourcePane === targetPane);
        });
        if (documentsUploadBtn) {
          documentsUploadBtn.style.display = targetPane === 'documents' ? 'inline-flex' : 'none';
        }
        if (targetPane !== 'images') {
          closeImageFolder();
        }
        updateImageTileDraggableState();
        updateDocumentRowDraggableState();
      }

      function updateImageTileDraggableState() {
        const enableDrag = !!(ordersShell && ordersShell.classList.contains('is-manage-mode') && imageDetailIsActive());
        getImageTiles().forEach(function (tile) {
          tile.setAttribute('draggable', enableDrag ? 'true' : 'false');
        });
      }

      function updateDocumentRowDraggableState() {
        const documentsPane = document.querySelector('[data-resource-pane="documents"]');
        const enableDrag = !!(ordersShell && ordersShell.classList.contains('is-manage-mode') && documentsPane && documentsPane.classList.contains('is-active'));
        getDocumentRows().forEach(function (row) {
          row.setAttribute('draggable', enableDrag ? 'true' : 'false');
        });
      }

      function openImageFolder(folderName) {
        currentFolderName = folderName;
        if (imageFolderDetailTitle) imageFolderDetailTitle.textContent = folderName;
        if (imageFolderList) imageFolderList.style.display = 'none';
        if (imageFolderDetail) imageFolderDetail.classList.add('is-active');
        clearImageSelections();
        updateImageTileDraggableState();
      }

      function closeImageFolder() {
        if (imageFolderList) imageFolderList.style.display = 'grid';
        if (imageFolderDetail) imageFolderDetail.classList.remove('is-active');
        clearImageSelections();
        updateImageTileDraggableState();
      }

      function bindImageFolderCard(card) {
        if (!card) return;
        card.addEventListener('click', function () {
          const inManageMode = !!(ordersShell && ordersShell.classList.contains('is-manage-mode'));
          if (imagesPaneIsActive() && inManageMode && !imageDetailIsActive()) {
            card.classList.toggle('is-selected');
            updateFolderSelectionCount();
            updateManageDeleteState();
            return;
          }
          openImageFolder(card.dataset.folderOpen || 'Folder');
        });
      }

      resourceTabs.forEach(function (tab) {
        tab.addEventListener('click', function () {
          setActiveResourcePane(tab.dataset.resourceTab);
        });
      });

      imageFolderCards.forEach(function (card) {
        bindImageFolderCard(card);
      });

      if (imageFolderBack) {
        imageFolderBack.addEventListener('click', function () {
          closeImageFolder();
        });
      }
      ...
      document.addEventListener('click', function (event) {
        ...
        openImagePreview(tile.textContent.trim() || 'Image Preview');
      });

      if (manageToggle && ordersShell) {
        manageToggle.addEventListener('click', function () {
          const isActive = manageToggle.classList.toggle('is-active');
          ordersShell.classList.toggle('is-manage-mode', isActive);
          updateImageTileDraggableState();
          updateDocumentRowDraggableState();
          if (!isActive) {
            clearAllSelections();
      ...
      document.addEventListener('dragstart', function (event) {
        const documentRow = event.target.closest('[data-resource-pane="documents"] .orders-row');
        if (documentRow) {
          const documentsPane = document.querySelector('[data-resource-pane="documents"]');
          if (!ordersShell || !ordersShell.classList.contains('is-manage-mode') || !documentsPane || !documentsPane.classList.contains('is-active')) {
            event.preventDefault();
            return;
          }
          draggedDocumentRow = documentRow;
        ...
        const tile = event.target.closest('.image-tile');
        if (!tile) return;
        if (!ordersShell || !ordersShell.classList.contains('is-manage-mode')) {
          event.preventDefault();
          return;
        }
        if (!imageDetailIsActive()) {
          event.preventDefault();
          return;
        }
        draggedImageTile = tile;
      ...
      document.addEventListener('dragend', function (event) {
        ...
        draggedImageTile = null;
      });

      const ordersTable = document.querySelector('[data-resource-pane="documents"] .orders-table');
      if (ordersTable) {
        ordersTable.addEventListener('dragover', function (event) {
          if (!draggedDocumentRow) return;
          const targetRow = event.target.closest('.orders-row');
          if (!targetRow || targetRow === draggedDocumentRow) return;
          event.preventDefault();
        });

        ordersTable.addEventListener('drop', function (event) {
          if (!draggedDocumentRow) return;
          const targetRow = event.target.closest('.orders-row');
          if (!targetRow || targetRow === draggedDocumentRow) return;
          event.preventDefault();
          ...
          if (insertAfter) {
            targetRow.after(draggedDocumentRow);
          } else {
            targetRow.before(draggedDocumentRow);
          }

          draggedDocumentRow.classList.remove('is-dragging');
          draggedDocumentRow = null;
          markManageChanged();
        });
      }
      ...
      if (imageThumbGrid) {
        imageThumbGrid.addEventListener('dragover', function (event) {
          if (!draggedImageTile) return;
          const target = event.target.closest('.image-tile');
          if (!target || target === draggedImageTile) return;
          event.preventDefault();
        });

        imageThumbGrid.addEventListener('drop', function (event) {
          if (!draggedImageTile) return;
          const target = event.target.closest('.image-tile');
          if (!target || target === draggedImageTile) return;
          event.preventDefault();
          ...
          if (insertAfter) {
            target.after(draggedImageTile);
          } else {
            target.before(draggedImageTile);
          }

          draggedImageTile.classList.remove('is-dragging');
          draggedImageTile = null;
          markManageChanged();
        });
      }
      ...
      document.addEventListener('change', function (event) {
        if (event.target.matches('.manage-select-cell .manage-checkbox')) {
          syncSelectAllState();
          updateManageDeleteState();
        }
        if (event.target.matches('.manage-access-select')) {
          markManageChanged();
        }
      });
      ...
      if (newFolderBtn) {
        newFolderBtn.addEventListener('click', function () {
          if (!ordersShell || !ordersShell.classList.contains('is-manage-mode')) return;
          if (newFolderOverlay) newFolderOverlay.classList.add('is-open');
        });
      }

      if (newFolderCancel) {
        newFolderCancel.addEventListener('click', closeNewFolder);
      }

      if (newFolderCreate) {
        newFolderCreate.addEventListener('click', function () {
          const folderName = newFolderInput ? newFolderInput.value.trim() : '';
          if (!folderName || !imageFolderList || !imageFolderTemplate) {
            closeNewFolder();
            return;
          }
          const fragment = imageFolderTemplate.content.cloneNode(true);
          const newCard = fragment.querySelector('.image-folder-card');
          const nameEl = fragment.querySelector('.image-folder-name');
          if (newCard) newCard.dataset.folderOpen = folderName;
          if (nameEl) nameEl.textContent = folderName;
          imageFolderList.appendChild(fragment);
          const appendedCard = imageFolderList.lastElementChild;
          bindImageFolderCard(appendedCard);
          closeNewFolder();
          markManageChanged();
        });
      }
      ...
      if (newFolderOverlay) {
        newFolderOverlay.addEventListener('click', function (event) {
          if (event.target === newFolderOverlay) closeNewFolder();
        });
      }
      ...
      if (renameFolderBtn) {
        renameFolderBtn.addEventListener('click', function () {
          if (!ordersShell || !ordersShell.classList.contains('is-manage-mode')) return;
          if (!imageDetailIsActive()) return;
          if (renameFolderInput) renameFolderInput.value = currentFolderName || '';
          if (renameFolderOverlay) renameFolderOverlay.classList.add('is-open');
        });
      }

      if (renameFolderCancel) {
        renameFolderCancel.addEventListener('click', closeRenameFolder);
      }

      if (renameFolderSave) {
        renameFolderSave.addEventListener('click', function () {
          const nextName = renameFolderInput ? renameFolderInput.value.trim() : '';
          if (!nextName) {
            closeRenameFolder();
            return;
          }
          ...
          if (targetCard) {
            targetCard.dataset.folderOpen = nextName;
            const nameEl = targetCard.querySelector('.image-folder-name');
            if (nameEl) nameEl.textContent = nextName;
          }
          currentFolderName = nextName;
          if (imageFolderDetailTitle) imageFolderDetailTitle.textContent = nextName;
          closeRenameFolder();
          markManageChanged();
        });
      }

      if (renameFolderOverlay) {
        renameFolderOverlay.addEventListener('click', function (event) {
          if (event.target === renameFolderOverlay) closeRenameFolder();
        });
      }
      ...
      if (imagePreviewPrev) {
        imagePreviewPrev.addEventListener('click', function () {
          moveImagePreview(-1);
        });
      }
      ...
      if (imagePreviewStage) {
        imagePreviewStage.addEventListener('touchstart', function (event) {
          if (!event.touches || !event.touches.length) return;
          touchStartX = event.touches[0].clientX;
        }, { passive: true });

        imagePreviewStage.addEventListener('touchend', function (event) {
      ...
      if (imageUploadBtn) {
        imageUploadBtn.addEventListener('click', function () {
          if (!ordersShell || !ordersShell.classList.contains('is-manage-mode')) return;
          if (!imageDetailIsActive()) return;
          if (imageUploadOverlay) imageUploadOverlay.classList.add('is-open');
        });
      }
      ...
      if (imageUploadChoose) {
        imageUploadChoose.addEventListener('click', function () {
          appendSampleImages(3);
          closeImageUpload();
        });
      }
      ...
      if (imageUploadOverlay) {
        imageUploadOverlay.addEventListener('click', function (event) {
          if (event.target === imageUploadOverlay) closeImageUpload();
        });
      }

      if (manageSaveBtn) {
        manageSaveBtn.addEventListener('click', function () {
          if (!manageSaveBtn.classList.contains('is-enabled')) return;
          showSaveStatus();
          resetManageChanged();
        });
      }
      ...
      if (manageDeleteBtn) {
        manageDeleteBtn.addEventListener('click', function () {
          if (!manageDeleteBtn.classList.contains('is-enabled')) return;

          if (imagesPaneIsActive() && folderListIsVisible()) {
            const selectedFolders = getSelectedFolderCards();
            const hasNonEmptyFolder = selectedFolders.some(function (card) {
              const infoEl = card.querySelector('.image-folder-info');
              const infoText = infoEl ? infoEl.textContent.trim().toLowerCase() : '';
              return infoText.indexOf('0 images') !== 0;
            });
            if (deleteConfirmTitle) deleteConfirmTitle.textContent = hasNonEmptyFolder ? 'Only empty folders can be deleted' : 'Delete selected folders?';
            if (deleteConfirmText) deleteConfirmText.textContent = hasNonEmptyFolder ? 'Remove images inside the folder first, or create and delete only an empty folder.' : 'This will remove the selected empty folders from the current image library.';
          } else if (imagesPaneIsActive() && imageDetailIsActive()) {
            if (deleteConfirmTitle) deleteConfirmTitle.textContent = 'Delete selected images?';
            if (deleteConfirmText) deleteConfirmText.textContent = 'This action will remove the selected images from the current folder.';
          } else {
            if (deleteConfirmTitle) deleteConfirmTitle.textContent = 'Delete selected files?';
            if (deleteConfirmText) deleteConfirmText.textContent = 'This action will remove the selected resource items from the current list.';
          }

          if (deleteConfirmOverlay) deleteConfirmOverlay.classList.add('is-open');
        });
      }
      ...
      if (deleteConfirmBtn) {
        deleteConfirmBtn.addEventListener('click', function () {
          if (imagesPaneIsActive() && imageDetailIsActive()) {
            removeSelectedImages();
          } else if (imagesPaneIsActive() && folderListIsVisible()) {
            const selectedFolders = getSelectedFolderCards();
            const hasNonEmptyFolder = selectedFolders.some(function (card) {
              const infoEl = card.querySelector('.image-folder-info');
              const infoText = infoEl ? infoEl.textContent.trim().toLowerCase() : '';
      ...
      updateManageDeleteState();
      updateManageSaveState();
      setActiveResourcePane('documents');
      updateDocumentRowDraggableState();
};`;function se({onOpenMainPage:e,onOpenMeasurePage:t,onOpenQuotesPage:n,onOpenOrdersPage:r,onOpenClientsPage:i,onOpenResourcesPage:a,onOpenAdminPage:o}){return(0,l.useEffect)(()=>{let s=document.createElement(`script`);s.type=`text/javascript`,s.dataset.wincoResourcesPage=`true`,s.text=oe,document.body.appendChild(s);let c=(()=>{let s=document.querySelector(`.resources-page`);if(!s)return()=>{};let c=s.querySelectorAll(`.topbar-left .nav-item`),l=[];return c.forEach(s=>{let c=s.textContent.trim(),u=null;if(c===`Charles / Winco`&&(u=e),c===`Measure`&&(u=t),c===`Quotes`&&(u=n),c===`Orders`&&(u=r),c===`Clients`&&(u=i),c===`Resources`&&(u=a),c===`Admin`&&(u=o),u){let e=()=>u();s.style.cursor=`pointer`,s.addEventListener(`click`,e),l.push([s,e])}}),()=>{l.forEach(([e,t])=>{e.removeEventListener(`click`,t)})}})(),l=window.setTimeout(()=>{typeof window.initResourcesPage==`function`&&window.initResourcesPage()},0);return()=>{typeof c==`function`&&c(),window.clearTimeout(l),s.parentNode&&s.parentNode.removeChild(s),window.initResourcesPage&&delete window.initResourcesPage}},[]),(0,p.jsx)(`div`,{className:`resources-page`,dangerouslySetInnerHTML:{__html:ae}})}function ce({onOpenMainPage:e,onOpenMeasurePage:t,onOpenQuotesPage:n,onOpenOrdersPage:r,onOpenClientsPage:i,onOpenResourcesPage:a,onOpenAdminFabricPage:o,onOpenAdminHardwarePage:s,onOpenAdminControlSystemPage:c,onOpenAdminPricingPage:l,onOpenAdminAccountsPage:u}){let d=o=>{o===`Charles / Winco`&&e&&e(),o===`Measure`&&t&&t(),o===`Quotes`&&n&&n(),o===`Orders`&&r&&r(),o===`Clients`&&i&&i(),o===`Resources`&&a&&a()},f=e=>{e===`Fabric`&&o&&o(),e===`Hardware`&&s&&s(),e===`Control System`&&c&&c(),e===`Pricing`&&l&&l(),e===`Accounts`&&u&&u()};return(0,p.jsx)(`div`,{className:`admin-page`,children:(0,p.jsx)(`div`,{className:`app`,children:(0,p.jsxs)(`div`,{className:`page`,children:[(0,p.jsx)(`nav`,{className:`main-nav`,children:(0,p.jsxs)(`div`,{className:`main-nav-inner`,children:[(0,p.jsxs)(`div`,{className:`main-nav-left`,children:[(0,p.jsx)(`button`,{className:`main-nav-item account`,type:`button`,onClick:()=>d(`Charles / Winco`),children:`Charles / Winco`}),(0,p.jsx)(`div`,{className:`main-nav-separator`,children:`|`}),(0,p.jsx)(`button`,{className:`main-nav-item`,type:`button`,onClick:()=>d(`Measure`),children:`Measure`}),(0,p.jsx)(`button`,{className:`main-nav-item`,type:`button`,onClick:()=>d(`Quotes`),children:`Quotes`}),(0,p.jsx)(`button`,{className:`main-nav-item`,type:`button`,onClick:()=>d(`Orders`),children:`Orders`}),(0,p.jsx)(`button`,{className:`main-nav-item`,type:`button`,onClick:()=>d(`Clients`),children:`Clients`}),(0,p.jsx)(`button`,{className:`main-nav-item`,type:`button`,onClick:()=>d(`Resources`),children:`Resources`}),(0,p.jsx)(`div`,{className:`main-nav-item current`,children:`Admin`})]}),(0,p.jsx)(`div`,{className:`main-nav-actions`})]})}),(0,p.jsx)(`nav`,{className:`admin-subnav`,"aria-label":`Admin sections`,children:(0,p.jsxs)(`div`,{className:`admin-subnav-inner`,children:[(0,p.jsx)(`button`,{className:`admin-subnav-item`,type:`button`,onClick:()=>f(`Fabric`),children:`Fabric`}),(0,p.jsx)(`button`,{className:`admin-subnav-item`,type:`button`,onClick:()=>f(`Hardware`),children:`Hardware`}),(0,p.jsx)(`button`,{className:`admin-subnav-item`,type:`button`,onClick:()=>f(`Control System`),children:`Control System`}),(0,p.jsx)(`button`,{className:`admin-subnav-item`,type:`button`,onClick:()=>f(`Pricing`),children:`Pricing`}),(0,p.jsx)(`button`,{className:`admin-subnav-item`,type:`button`,onClick:()=>f(`Accounts`),children:`Accounts`})]})})]})})})}function le(){let[e,t]=(0,l.useState)(!1),[n,r]=(0,l.useState)(`main`),i=()=>r(`main`),a=()=>r(`measure`),o=()=>r(`quotes`),s=()=>r(`orders`),c=()=>r(`clients`),u=()=>r(`resources`),d=()=>r(`admin`);return e?n===`measure`?(0,p.jsx)(b,{onOpenMainPage:i,onOpenMeasurePage:a,onOpenQuotesPage:o,onOpenOrdersPage:s,onOpenClientsPage:c,onOpenResourcesPage:u,onOpenAdminPage:d}):n===`quotes`?(0,p.jsx)(S,{onOpenMainPage:i,onOpenMeasurePage:a,onOpenQuotesPage:o,onOpenOrdersPage:s,onOpenClientsPage:c,onOpenResourcesPage:u,onOpenAdminPage:d}):n===`orders`?(0,p.jsx)(ne,{onOpenMainPage:i,onOpenMeasurePage:a,onOpenQuotesPage:o,onOpenOrdersPage:s,onOpenClientsPage:c,onOpenResourcesPage:u,onOpenAdminPage:d}):n===`clients`?(0,p.jsx)(ie,{onOpenMainPage:i,onOpenMeasurePage:a,onOpenQuotesPage:o,onOpenOrdersPage:s,onOpenClientsPage:c,onOpenResourcesPage:u,onOpenAdminPage:d}):n===`resources`?(0,p.jsx)(se,{onOpenMainPage:i,onOpenMeasurePage:a,onOpenQuotesPage:o,onOpenOrdersPage:s,onOpenClientsPage:c,onOpenResourcesPage:u,onOpenAdminPage:d}):n===`admin`?(0,p.jsx)(ce,{onOpenMainPage:i,onOpenMeasurePage:a,onOpenQuotesPage:o,onOpenOrdersPage:s,onOpenClientsPage:c,onOpenResourcesPage:u,onOpenAdminPage:d}):(0,p.jsx)(_,{onOpenMeasurePage:a,onOpenQuotesPage:o,onOpenOrdersPage:s,onOpenClientsPage:c,onOpenResourcesPage:u,onOpenAdminPage:d}):(0,p.jsx)(g,{onLogin:()=>{t(!0),r(`main`)}})}(0,u.createRoot)(document.getElementById(`root`)).render((0,p.jsx)(l.StrictMode,{children:(0,p.jsx)(le,{})}));